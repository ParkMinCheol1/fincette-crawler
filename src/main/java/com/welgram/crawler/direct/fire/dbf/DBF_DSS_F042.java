...
public class DBF_DSS_F042 extends CrawlingDBFAnnounce {

    // 1Q초간편건강보험 2304 06종_3대질병플랜_간편고지(1Q)_해약환급금 지급형_납면미적용_세만기
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F042(), args);
    }
...
//            }
            if (labelText.contains("06종_3대질병플랜_간편고지(1Q)_해약환급금 지급형_납면미적용_")) {
                $label.click();
                logger.info("클릭한 가입유형 : {}", labelText);
            }
        }
