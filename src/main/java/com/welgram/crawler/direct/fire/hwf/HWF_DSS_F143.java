...
public class HWF_DSS_F143 extends CrawlingHWFAnnounce{

    // 한화 시그니처 여성 355실속간편건강보험2310 무배당(간편고지형)1종(납입후50%해약환급금지급형, 납입면제 운영형, 355간편고지형Ⅱ) - 갱신주기 20년
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F143(), args);
    }
