...
public class DBF_DSS_F034 extends CrawlingDBFAnnounce {

    // 나에게맞춘플러스종합보험 2304 01종_자유설계_해약환급금지급형_납면적용_세만기
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F034(), args);
    }
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        // 플랜 서브네임: 03종_자유설계_해약환급금미지급형B_납면적용_세만기 -> 해당 네임으로 가입상품 선택
