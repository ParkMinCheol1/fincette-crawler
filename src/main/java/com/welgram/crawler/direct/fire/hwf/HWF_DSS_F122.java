...
public class HWF_DSS_F122 extends CrawlingHWFAnnounce {

    // 한화 3N5 WELL100 간편건강보험(연만기 갱신형)2310 무배당(일반고지형) 3종(납입면제 일반형, 일반고지형)
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F122(), args);
    }
