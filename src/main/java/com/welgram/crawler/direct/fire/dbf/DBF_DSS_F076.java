...
public class DBF_DSS_F076 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 나에게맞춘간편건강보험2307 11종_맞춤간편고지3.0.5_납면미적용_해약환급금지급_갱신_자유설계
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F076(), args);
    }
