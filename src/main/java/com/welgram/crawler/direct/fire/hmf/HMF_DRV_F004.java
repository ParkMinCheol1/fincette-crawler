...
public class HMF_DRV_F004 extends CrawlingHMFAnnounce {

	// 행복누리 운전자보험 고급형
	public static void main(String[] args) {
		executeCommand(new HMF_DRV_F004(), args);
	}
...
//		WebElement $inputB = driver.findElement(By.id("rdoMatKind_A"));
		WebElement $inputB = driver.findElement(By.id("rdoMatKind_B"));
		clickButton($inputB);
//		setProductTypeRadio("grid_ch", info.planSubName);
