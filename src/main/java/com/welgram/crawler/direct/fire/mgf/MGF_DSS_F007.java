...
/**
 * @author user MG손해보험 (무)원더풀 착한간편건강보험 (세만기형)(1종,간편고지형(335+1)_해약환급금미지급형(납입후50%)
 */
public class MGF_DSS_F007 extends CrawlingMGFAnnounce {

    public static void main(String[] args) {
        executeCommand(new MGF_DSS_F007(), args);
    }
