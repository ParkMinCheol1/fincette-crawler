...
public class DBF_DSS_F056 extends CrawlingDBFAnnounce {

    // 참좋은3.2.5-1간편건강보험2307 09종_자유설계_간편고지(3Q)_해약환급금 미지급형_(납중0%/납후50%)_납면적용_세만기
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F056(), args);
    }
