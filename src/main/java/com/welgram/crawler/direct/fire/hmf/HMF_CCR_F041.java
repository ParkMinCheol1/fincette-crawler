...
public class HMF_CCR_F041 extends CrawlingHMFAnnounce {

	// 무배당 흥Good 모두 담은 암보험(24.01)_(2종)(30년갱신형)(해약환급금지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_CCR_F041(), args);
	}
