...
// (무) NH335더블굿패스건강보험[3종:해약환급금미지급형Ⅱ(간편심사/납면)]2304
public class NHF_DSS_F004 extends CrawlingNHFAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHF_DSS_F004(), args);
    }
...
//        option.setTouchEnPc(true);
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHF_DSS_F004 :: {}", info.getProductName());
        WaitUtil.waitFor(5);
