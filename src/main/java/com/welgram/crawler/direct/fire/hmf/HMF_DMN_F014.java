...
public class HMF_DMN_F014 extends CrawlingHMFAnnounce {

	// 무배당 흥Good 모두 담은 123 치매보험(24.01)_(1종)(일반심사형)(무해약 납입후 50%해약환급금지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_DMN_F014(), args);
	}
