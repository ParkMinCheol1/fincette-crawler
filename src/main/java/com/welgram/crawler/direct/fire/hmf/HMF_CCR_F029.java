...
public class HMF_CCR_F029 extends CrawlingHMFAnnounce {

	// 무배당 흥Good 모두 담은 암보험(23.08)_(2종)(20년갱신형)(해약환급금지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_CCR_F029(), args);
	}
	...
	private void crawlFromAnnounce(CrawlingProduct info) throws Exception{
		...
		logger.info("보험기간 설정");
		setAnnounceTerms("select_PAYMENT_INSURANCE_PERIODCD", info.napTerm, info.insTerm);
...
//					if (!exceptionText.equals("skip")) {
//						helper.doSelectBox(termSelect, treaty.insTerm, false);
