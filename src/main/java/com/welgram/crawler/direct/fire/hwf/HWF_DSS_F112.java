...
public class HWF_DSS_F112 extends CrawlingHWFAnnounce {

    // 한화 333 WELL100 실속간편건강보험2310 무배당(간편고지형) 1종(납입후50%해약환급금지급형, 납입면제 운영형, 간편고지형Ⅱ)
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F112(), args);
    }
