...
public class HWF_DSS_F121 extends CrawlingHWFAnnounce {

    // 한화 3N5 WELL100 간편건강보험(연만기 갱신형)2310 무배당(간편고지형) 2종(납입면세 미운영형, 3N5간편고지형) - 3대,4형(325간편고지형)
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F121(), args);
    }
