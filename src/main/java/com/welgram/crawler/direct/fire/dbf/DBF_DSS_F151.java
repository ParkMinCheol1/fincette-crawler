...
public class DBF_DSS_F151 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 나에게맞춘2Q간편건강보험2309 41종_맞춤2Q간편고지2.1.0_납면적용_해약환급금미지급_(납중0%/납후50%)_세만기_자유설계

    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F151(), args);
    }
