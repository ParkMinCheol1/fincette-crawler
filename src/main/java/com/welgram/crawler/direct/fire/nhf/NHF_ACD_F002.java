...
// 2023.05.17 서용호
// (무) NH탑클래스상해보험[3종:100플랜]
public class NHF_ACD_F002 extends CrawlingNHFAnnounce {

    public static void main(String[] args) {
        executeCommand(new NHF_ACD_F002(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHF_ACD_F002 :: {}", info.getProductCode());
        WaitUtil.waitFor(3);
