...
public class NHF_CHL_F001 extends CrawlingNHFAnnounce {


	public static void main(String[] args) {
		executeCommand(new NHF_CHL_F001(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHF_CHL_F001 :: {}", info.getProductCode());
		WaitUtil.waitFor(3);
		...
		logger.info("태아가입여부 :: 미가입");
		setFetalStatus(By.id("fetlEntPsbYn"), "미가입");
