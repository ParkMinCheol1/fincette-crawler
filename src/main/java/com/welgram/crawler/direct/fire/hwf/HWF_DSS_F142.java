...
public class HWF_DSS_F142 extends CrawlingHWFAnnounce{

    // 한화 시그니처 여성 355간편건강보험(연만기 갱신형)2310 무배당(일반고지형) 6종(납입면제 미운영형, 일반고지형)
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F142(), args);
    }
