...
public class HMF_DSS_F134 extends CrawlingHMFAnnounce {

	// 무배당 흥국화재 든든한 355 간편종합보험(24.01)_(1종)(경증간편가입형Ⅲ)(무해약 납입후 표준환급률 지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_DSS_F134(), args);
	}
