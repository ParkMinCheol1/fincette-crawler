...
public class HWF_DSS_F131 extends CrawlingHWFAnnounce {

    // 한화 3N5 WELL100 실속간편건강보험2310 무배당(일반고지형) 8종(기본형, 납입면제 미운영형, 일반고지형)- 100세 20년납, 갱신주기 20년
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F131(), args);
    }
