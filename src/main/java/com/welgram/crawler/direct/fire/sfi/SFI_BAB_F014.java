...
public class SFI_BAB_F014 extends CrawlingSFIAnnounce {

    public static void main(String[] args) {
        executeCommand(new SFI_BAB_F014(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("태아 탭 클릭");
        $button = helper.waitElementToBeClickable(driver.findElement(By.id("tab_seq_0")));
        click($button);
        ...
        logger.info("간편유형 구분 설정");
        $select = driver.findElement(By.id("c_simpDsTypCd"));
        setPrevalenceType($select, "325-5");
...
//                String returnMoneyMin = ((DeferredElementImpl) item).getAttribute("sr20").toString();
//                String returnRateMin = ((DeferredElementImpl) item).getAttribute("sr21").toString();
                String returnMoney = ((DeferredElementImpl) item).getAttribute("sr16").toString();
                String returnRate = ((DeferredElementImpl) item).getAttribute("sr17").toString();
//                String returnMoneyAvg = ((DeferredElementImpl) item).getAttribute("sr47").toString();
//                String returnRateAvg = ((DeferredElementImpl) item).getAttribute("sr48").toString();
