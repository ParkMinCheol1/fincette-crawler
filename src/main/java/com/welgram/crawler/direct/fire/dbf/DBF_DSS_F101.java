...
public class DBF_DSS_F101 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 나에게맞춘간편건강보험2307 52종_맞춤간편고지3.2.5_납면미적용_해약환급금미지급_(납중0%/납후50%)_세만기_자유설계
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F101(), args);
    }
