...
public class DBF_DSS_F146 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 나에게맞춘2Q간편건강보험2309 31종_맞춤2Q간편고지2.1.0_납면미적용_해약환급금지급_세만기_자유설계
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F146(), args);
    }
