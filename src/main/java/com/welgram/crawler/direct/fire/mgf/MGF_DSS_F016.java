...
/**
 * @author user MG손해보험 (무)원더풀 착한간편건강보험 ♡ 0★0
 *
 * 서브네임 : (세만기형)(5종,일반고지형_해약환급금미지급형(납입후50%)
 */
public class MGF_DSS_F016 extends CrawlingMGFAnnounce {

    public static void main(String[] args) {
        executeCommand(new MGF_DSS_F016(), args);
    }
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        setProductType(driver.findElement(By.xpath("//*[@id=\"is011650dmPdcd\"]//label[contains(.,'" + info.getTextType() + "')]")));
