...
// (무) 투패스초간편건강보험[1종:31초간편심사형(납입면제형)]2301
public class NHF_DSS_F001 extends CrawlingNHFAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHF_DSS_F001(), args);
    }
...
//        option.setTouchEnPc(true);
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHF_DSS_F001 :: {}", info.getProductName());
        WaitUtil.waitFor(5);
