...
public class MGF_DSS_D011 extends CrawlingMGFDirect {
    public MGF_DSS_D011() {
    }

    public static void main(String[] args) {
        executeCommand(new MGF_DSS_D011(), args);
    }
    ...
    public void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        btnClick(driver.findElement(By.cssSelector("#cont > div.cont_set.bg01.PLAN01 > button")), 1);
