...
public class DBF_ACD_F012 extends CrawlingDBFAnnounce {

    public static void main(String[] args) {
        executeCommand(new DBF_ACD_F012(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("만기환급금 크롤링");
        WebElement $returnPremiumTd = driver.findElement(By.xpath("//table[@id='tableResult']//td[@class='rt']"));
        crawlReturnPremium($returnPremiumTd, info);
