...
public class SFI_BAB_D011 extends CrawlingSFIDirect {

    public static void main(String[] args) {
        executeCommand(new SFI_BAB_D011(), args);
    }
    ...
    public void setBirthday(Object... obj) throws SetBirthdayException {
        String title = "엄마의 생년월일";
        String expectedFullBirth = (String) obj[0];
        String actualFullBirth = "";

        try {
            // 생년월일 element 찾기
            WebElement $birthInput = driver.findElement(By.id("birth-input"));
