...
// 2023.12.05 | 최우진 | 운전자보험은 신한이지(무배당)
public class SHF_DRV_F003 extends CrawlingSHF {

    public static void main(String[] args) { executeCommand(new SHF_DRV_F003(), args); }
...
//        driver.findElement(By.xpath("//span[text()='보험료 계산하기'/parent::a]")).click();
        ...
        for (WebElement tr : tr$returnMoneyList) {
            ...
            returnMoney = (returnMoney.contains("-")) ? "0" : returnMoney.replaceAll("[^0-9]", "");
