...
public class HWF_DSS_F126 extends CrawlingHWFAnnounce {

    // 한화 3N5 WELL100 실속간편건강보험2310 무배당(간편고지형) 3종(기본형, 납입면제 운영형, 3N5간편고지형)  - 100세 20년납, 갱신주기 20년, 4형(325간편고지형)
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F126(), args);
    }
