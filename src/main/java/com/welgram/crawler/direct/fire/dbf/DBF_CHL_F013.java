...
public class DBF_CHL_F013 extends CrawlingDBFAnnounce {

    public static void main(String[] args) {
        executeCommand(new DBF_CHL_F013(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("보험기간 선택 (20년만기자동갱신)");
        WebElement $termSelect = driver.findElement(By.xpath("//*[@id='form1']/div[2]/div[3]/div[2]/div/table/tbody/tr[2]/td[2]/div/select"));
