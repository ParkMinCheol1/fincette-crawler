...
public class HWF_DSS_F162 extends CrawlingHWFAnnounce {

    // 한화 시그니처 여성 건강보험2310 무배당 2종(납입면제형, 납입후50%해약환급금지급형) - 100세만기 20년납, 1형(일반고지형), 갱신주기 20년 // 3대
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F162(), args);
    }
