...
public class DBF_DSS_F022 extends CrawlingDBFAnnounce {

    // 참착한新3.3.5간편건강보험2304 06종_자유설계_경증Ⅱ간편고지(3Q)_해약환급금미지급형_(납중0%/납후50%)_납면미적용_세만기
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F022(), args);
    }
