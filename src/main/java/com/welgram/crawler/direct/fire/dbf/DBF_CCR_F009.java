...
public class DBF_CCR_F009 extends CrawlingDBFAnnounce {

    // New I'mOK 암보험 2304(해약환급금 지급형_납면적용_세만기) 최신항암치료비형
    public static void main(String[] args) {
        executeCommand(new DBF_CCR_F009(), args);
    }
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        logger.info("적립환급금지급시기 선택 : 70세 고정");
        WebElement $refundPeriodSelect = driver.findElement(By.cssSelector("select[name=accu_rprm_pyn_pd_dvcd]"));
        setRefundPeriod($refundPeriodSelect, "70세");
