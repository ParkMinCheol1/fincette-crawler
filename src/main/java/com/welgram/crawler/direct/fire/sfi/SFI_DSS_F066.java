...
public class SFI_DSS_F066 extends CrawlingSFIAnnounce {

    public static void main(String[] args) {
        executeCommand(new SFI_DSS_F066(), args);
    }
    ...
    public void crawlReturnMoneyList(Object... obj) throws ReturnMoneyListCrawlerException {
        try {
            ...
            for (int i = 0; i < sr.getLength(); i++) {
                ...
                String returnMoney = ((DeferredElementImpl) item).getAttribute("sr45").toString();
                String returnRate = ((DeferredElementImpl) item).getAttribute("sr46").toString();
