...
public class DBF_CHL_F019 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 청춘어람종합보험2309 04종_해약환급금지급형_납면적용_갱신형
    public static void main(String[] args) {
        executeCommand(new DBF_CHL_F019(), args);
    }
...
//        setProductType("sl_pan_cd", info.getTextType());
        ...
        logger.info("보험기간 선택 : 20년만기20년납");
        WebElement $termSelect = driver.findElement(By.xpath("//*[@id='form1']/div[2]/div[3]/div[2]/div/table/tbody/tr[1]/td[2]/div/select"));
