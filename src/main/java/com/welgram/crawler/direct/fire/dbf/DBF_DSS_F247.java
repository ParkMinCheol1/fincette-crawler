...
public class DBF_DSS_F247 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 나에게맞춘간편건강보험2309 20종_맞춤간편고지3.0.5_납면적용_해약환급금지급_세만기_자유설계
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F247(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        setProductType("sl_pan_cd", info.textType.split("#")[0]);

        logger.info("운전형태 : 자가용 고정");
        setVehicle("DRIVE_TYPE_CD", "자가용");

        logger.info("계약갱신주기 선택(20년만기자동갱신)");
        WebElement $termSelect = driver.findElement(By.xpath("//*[@id='form1']/div[2]/div[4]/div[2]/div/table/tbody/tr[2]/td[2]/div/select"));
        String insNapTerm = info.textType.split("#")[1];
