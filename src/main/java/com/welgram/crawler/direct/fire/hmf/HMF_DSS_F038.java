...
public class HMF_DSS_F038 extends CrawlingHMFAnnounce {

	// 무배당 흥국화재 든든한 325 간편종합보험(23.07)_(2종)(15년갱신형)(간편가입형)(해약환급금지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_DSS_F038(), args);
	}
	...
	private void crawlFromAnnounce(CrawlingProduct info) throws Exception{
		...
		logger.info("합계보험료 설정 : (고정)1");
		setTextToInputBox(By.id("TBIB061_ACU_PREM2"), "1");
