...
public class DBF_DSS_F003 extends CrawlingDBFAnnounce {

    // 참좋은3.2.5간편건강보험 2304(09종_자유설계_간편고지(3Q)_해약환급금 미지급형_(납중0%/납후50%)_납면적용_세만기)
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F003(), args);
    }
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        // 플랜 서브네임: 09종_자유설계_간편고지(3Q)_해약환급금 미지급형_(납중0%/납후50%)_납면적용_세만기 -> 해당 네임으로 가입상품 선택
