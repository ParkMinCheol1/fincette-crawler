...
public class DBF_DSS_F011 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 THE좋은100세든든건강보험2304 (01종_해약환급금지급형_납면적용_세만기)
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F011(), args);
    }
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        // 플랜 서브네임: (01종_해약환급금지급형_납면적용_세만기)-> 해당 네임으로 가입상품 선택
