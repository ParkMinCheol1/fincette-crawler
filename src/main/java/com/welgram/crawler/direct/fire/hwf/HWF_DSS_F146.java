...
public class HWF_DSS_F146 extends CrawlingHWFAnnounce {

    // 한화 시그니처 여성 3N5간편건강보험 무배당 2종(납입면제형, 납입후50%해약환급금지급형, 3N5간편고지형) 4형(325간편고지형)
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F146(), args);
    }
