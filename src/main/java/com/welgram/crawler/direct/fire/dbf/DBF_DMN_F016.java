...
public class DBF_DMN_F016 extends CrawlingDBFAnnounce {

    // 간편한가족사랑간병치매보험 2304 8종_간편고지(1Q)_무해지_표준형환급금의(납입중0%/납입후50%)_실속형_치매
    public static void main(String[] args) {
        executeCommand(new DBF_DMN_F016(), args);
    }
