...
public class SFI_DSS_F080 extends CrawlingSFIAnnounce {

    public static void main(String[] args) {
        executeCommand(new SFI_DSS_F080(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("생년월일 설정");
        $input = helper.waitElementToBeClickable(driver.findElement(By.id("p_birthDt")));
