...
public class HWF_DSS_F138 extends CrawlingHWFAnnounce{

    // 한화 시그니처 여성355 간편건강보험(연만기 갱신형)2310 무배당(간편고지형) 2종(납입면제 미운영형, 355간편고지형Ⅱ) - 3대, 20년만기 전기납
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F138(), args);
    }
