...
public class MGF_CHL_F007 extends CrawlingMGFAnnounce {
    public MGF_CHL_F007() {
    }

    public static void main(String[] args) {
        executeCommand(new MGF_CHL_F007(), args);
    }
    ...
    public void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        setProductType(driver.findElement(By.xpath("//label[contains(.,'" + info.getTextType() + "')]")));
