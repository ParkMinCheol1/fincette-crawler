...
public class HWF_DSS_F140 extends CrawlingHWFAnnounce{

    // 한화 시그니처 여성 355간편건강보험(연만기 갱신형)2310 무배당(간편고지형) 4종(납입면제 미운영형, 355여성간편고지형)
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F140(), args);
    }
