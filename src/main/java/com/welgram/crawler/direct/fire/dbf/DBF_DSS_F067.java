...
public class DBF_DSS_F067 extends CrawlingDBFAnnounce {

    // 참착한新3.3.5간편건강보험2307 12종_자유설계_일반고지_해약환급금 미지급형_(납중0%/납후50%)_납면미적용_세만기
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F067(), args);
    }
