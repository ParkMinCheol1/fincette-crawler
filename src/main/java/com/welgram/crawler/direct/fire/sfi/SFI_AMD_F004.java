...
public class SFI_AMD_F004 extends CrawlingSFIAnnounce {

    public static void main(String[] args) {
        executeCommand(new SFI_AMD_F004(), args);
    }
    ...
    public void crawlReturnMoneyList(Object... obj) throws ReturnMoneyListCrawlerException {
        ...
        try {
            ...
            for (int i = 0; i < sr.getLength(); i++) {
                ...
                String returnMoney = ((DeferredElementImpl) item).getAttribute("sr2").toString(); // 공시이율 예상해약환급률
                String returnRate = ((DeferredElementImpl) item).getAttribute("sr3").toString(); // 공시이율 예상해약환급률
