...
public class SFI_CHL_F014 extends CrawlingSFIAnnounce {

    public static void main(String[] args) {
        executeCommand(new SFI_CHL_F014(), args);
    }
    ...
    public void crawlReturnPremium(Object... obj) throws ReturnPremiumCrawlerException {
        ...
        try {
            ...
            String returnPremium = helper.waitVisibilityOfElementLocated(By.id("zz7ParngAmtAm")).getText()
                .replaceAll("\\D", "");
    ...
    public void crawlReturnMoneyList(Object... obj) throws ReturnMoneyListCrawlerException {
        try {
            ...
            for (int i = 0; i < sr.getLength(); i++) {
                ...
                String returnMoney = ((DeferredElementImpl) item).getAttribute("sr20").toString();
                String returnRate = ((DeferredElementImpl) item).getAttribute("sr21").toString();
