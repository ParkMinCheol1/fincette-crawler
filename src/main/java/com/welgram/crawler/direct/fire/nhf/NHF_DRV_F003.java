...
// 무배당 NH올바른지구굿데이운전자보험230424
public class NHF_DRV_F003 extends CrawlingNHFAnnounce {



	public static void main(String[] args) {
		executeCommand(new NHF_DRV_F003(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHF_DRV_F003 :: {}", info.getProductName());
		WaitUtil.waitFor(3);
