...
public class NHF_BAB_F005 extends CrawlingNHFAnnounce {


	// (무)NH굿스타트건강보험[1종:해약환급금미지급형Ⅱ]2310 태아
	public static void main(String[] args) {
		executeCommand(new NHF_BAB_F005(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHF_BAB_F005 :: {}", info.getProductName());
