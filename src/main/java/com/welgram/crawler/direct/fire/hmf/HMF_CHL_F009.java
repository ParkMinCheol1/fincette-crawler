...
public class HMF_CHL_F009 extends CrawlingHMFAnnounce {

	// 무배당 흥Good 폼나는 MZ보험(24.01)_(2종)(무해약 납입후 50%해약환급금지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_CHL_F009(), args);
	}
	...
	private void crawlFromAnnounce(CrawlingProduct info) throws Exception{
		...
		logger.info("보험기간 설정");
		setAnnounceTerms("select_PAYMENT_INSURANCE_PERIODCD", "100세", info.napTerm);
			...
			for (CrawlingTreaty hompageT : hompageList) {
				...
				for (CrawlingTreaty welgramTreaty : welgramTreatyList) {
					if (treatyName.equals(welgramTreaty.getTreatyName())) {
						...
						if (td1Text.contains("납입면제")) {
							term = welgramTreaty.napTerm + "납 " + "20년만기";
