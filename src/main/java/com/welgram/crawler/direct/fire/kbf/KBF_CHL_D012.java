...
// 해약환급금 없는 상품
public class KBF_CHL_D012 extends CrawlingKBFDirect {

    public static void main(String[] args) { executeCommand(new KBF_CHL_D012(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        element.sendKeys(child);
        WaitUtil.waitFor(4);
        element = driver.findElement(By.xpath("//strong[text()='" + child + "']/parent::span"));
        element.click();
