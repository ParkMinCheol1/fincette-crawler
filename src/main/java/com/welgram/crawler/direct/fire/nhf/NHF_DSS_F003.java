...
// (무) NH가성비굿건강보험[5종:납입면제형/해약환급금미지급형Ⅱ]2304
public class NHF_DSS_F003 extends CrawlingNHFAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHF_DSS_F003(), args);
    }
...
//        option.setTouchEnPc(true);
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHF_DSS_F003 :: {}", info.getProductName());
        WaitUtil.waitFor(5);
