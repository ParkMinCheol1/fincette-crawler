...
public class HWF_SAV_F004 extends CrawlingHWFAnnounce {

    // 프리미엄저축보험2310 무배당 - 1종(금리연동형), 담보추가 필수(상해후유장해)
    public static void main(String[] args) {
        executeCommand(new HWF_SAV_F004(), args);
    }
    ...
    private void crawlFromAnnounce(CrawlingProduct info) throws Exception {
        ...
        WebElement $vehicleSelect = driver.findElement(By.name("i_car"));
    ...
    private void setTreatiesNew(List<CrawlingTreaty> treaties) throws CommonCrawlerException {
        ...
        try {
            ...
            WebElement $label = driver.findElement(By.xpath("//label[text()='" + treatyName + "']"));
            WebElement $tr = $label.findElement(By.xpath("./ancestor::tr[1]"));
