...
public class HWF_DSS_F137 extends CrawlingHWFAnnounce{

    // 한화 시그니처 여성 355간편건강보험(연만기 갱신형)2310 무배당(간편고지형) 1종(납입면제 일반형, 355간편고지형Ⅱ)
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F137(), args);
    }
