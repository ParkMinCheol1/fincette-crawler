...
public class HMF_DSS_F068 extends CrawlingHMFAnnounce {

	// 무배당 흥국화재 든든한 325 간편종합보험(23.08)(1종)(간편가입형)(무해약 납입후 표준환급률지급형) 신규 추가
	public static void main(String[] args) {
		executeCommand(new HMF_DSS_F068(), args);
	}
