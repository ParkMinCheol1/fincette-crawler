...
public class SFI_ACD_F005 extends CrawlingSFIAnnounce {

    public static void main(String[] args) {
        executeCommand(new SFI_ACD_F005(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        //최소보험료가 2만원으로 적립보험료가 무조건 발생하는 케이스!
        logger.info("1회 보험료 설정");
        setAssureMoney("20000");
    ...
    public void setAssureMoney(Object... obj) throws SetAssureMoneyException {
        ...
        try {
            ...
            $calcBtn = driver.findElement(By.xpath("//span[text()='보험료 계산']/parent::button"));
            click($calcBtn);
    ...
    public void crawlReturnMoneyList(Object... obj) throws ReturnMoneyListCrawlerException {
        try {
            ...
            for (int i = 0; i < sr.getLength(); i++) {
                ...
                String returnMoneyMin = ((DeferredElementImpl) item).getAttribute("sr16").toString();
                String returnRateMin = ((DeferredElementImpl) item).getAttribute("sr17").toString();
                String returnMoney = ((DeferredElementImpl) item).getAttribute("sr29").toString();
                String returnRate = ((DeferredElementImpl) item).getAttribute("sr30").toString();
                String returnMoneyAvg = ((DeferredElementImpl) item).getAttribute("sr31").toString();
                String returnRateAvg = ((DeferredElementImpl) item).getAttribute("sr32").toString();
