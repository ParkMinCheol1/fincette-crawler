...
public class HMF_CCR_F013 extends CrawlingHMFAnnounce {

	// 무배당 흥Good 내일이 든든한 암보험(23.03)_(1종)(해약환급금지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_CCR_F013(), args);
	}
	...
	private void crawlFromAnnounce(CrawlingProduct info) throws Exception{
		...
		logger.info("판매플랜 설정 : {}", info.planSubName);
		setProductType("select_SALE_PLAN", info.planSubName);
		...
		WebElement $vehicleSelect = driver.findElement(By.id("select_DRV_CARCD"));
		...
		WebElement $premium = driver.findElement(By.id("TBIB061_GRANT_PREM"));
