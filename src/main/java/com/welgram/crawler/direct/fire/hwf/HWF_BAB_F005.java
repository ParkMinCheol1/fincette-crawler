...
public class HWF_BAB_F005 extends CrawlingHWFAnnounce {

    // 무배당 한화 처음부터 함께하는 어린이보험2310 무배당1종(기본형) 태아 - 태아체크, 임신경과주 12주, 30세 20년, 갱신주기 20년
    public static void main(String[] args) {
        executeCommand(new HWF_BAB_F005(), args);
    }
