...
// todo | tesseract 케이스
public class KBF_AMD_F006 extends CrawlingKBFAnnounce {

    // 무배당 KB손보 간편가입 실손의료비보장보험 (23.01)
    public static void main(String[] args) { executeCommand(new KBF_AMD_F006(), args); }
