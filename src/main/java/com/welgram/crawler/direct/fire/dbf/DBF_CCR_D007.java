...
public class DBF_CCR_D007 extends CrawlingDBF {

	

	public static void main(String[] args) {
		executeCommand(new DBF_CCR_D007(), args);
	}
	...
	public void crawlFromHomepage(CrawlingProduct info) throws Exception {
		...
		helper.waitPresenceOfElementLocated(By.cssSelector("#_name_job_tab_ > div:nth-child(1) > div.wrap_inp.clear_input_box > input"))
			.sendKeys("사무원");
		...
		helper.waitForCSSElement(".loadmask");
		WaitUtil.waitFor(1);
		loopTreatyCheckBack(info, selectNum);
		...
		// 예상해약환급금 버튼 클릭
		logger.info("해약환급금");
		getReturnMoney(info, By.cssSelector("#sForm > div.wrap_contents > div.plan_total.ui_plan_slider > div.right_plan > dl > dd > a"));
	}

	private void setNapCycle(String napCycle) throws InterruptedException {

		elements = driver.findElements(
			By.cssSelector("#sForm > div.wrap_contents > div.plan_total.ui_plan_slider > dl.plan_bot_dl.last > dd > ul > li"));
