...
// (무) 투패스리치상해보험[1종:일반심사형1]
public class NHF_ACD_F004 extends CrawlingNHFAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHF_ACD_F004(), args);
    }
...
//        option.setTouchEnPc(true);
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHF_ACD_F004 :: {}", info.getProductCode());
        WaitUtil.loading(5);
