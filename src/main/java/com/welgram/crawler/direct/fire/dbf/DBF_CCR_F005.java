...
public class DBF_CCR_F005 extends CrawlingDBFAnnounce {

    // 참좋은간편암보험2210(01종_고급플랜_간편고지형)
    public static void main(String[] args) {
        executeCommand(new DBF_CCR_F005(), args);
    }
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        logger.info("계약갱신주기 선택");
        WebElement $termSelect = driver.findElement(By.cssSelector("select[name=pan_rnw_tpcd]"));
        String insTerm = info.insTerm + "만기자동갱신";
        setTerm($termSelect, insTerm);
