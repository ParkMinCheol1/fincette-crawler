...
public class DBF_DTL_F003 extends CrawlingDBFAnnounce {

	// 참좋은치아사랑보험 2301
	public static void main(String[] args) {
		executeCommand(new DBF_DTL_F003(), args);
	}
	...
	private void crawlFromHomepage(CrawlingProduct info) throws Exception {
		...
		logger.info("운전형태 : 자가용 고정");
		driver.findElement(By.cssSelector("#form1 > div:nth-child(11) > div:nth-child(4) > div.tbf.spr2 > div > table > tbody > tr:nth-child(1) > td > div > ul > li:nth-child(1) > label")).click();
		WaitUtil.waitFor(1);
