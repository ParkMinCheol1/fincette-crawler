...
public class DBF_DSS_F110 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 참좋은 훼밀리더블플러스종합보험2307 11종_해약환급금 지급형_납면적용(갱신보험기간)_갱신형
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F110(), args);
    }
