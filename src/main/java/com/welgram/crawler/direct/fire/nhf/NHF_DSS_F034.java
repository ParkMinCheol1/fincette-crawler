...
// (무)New간편한가성비플러스건강보험2304 1종:해약환급금미지급형Ⅱ(일반심사)
public class NHF_DSS_F034 extends CrawlingNHFAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHF_DSS_F034(), args);
    }
