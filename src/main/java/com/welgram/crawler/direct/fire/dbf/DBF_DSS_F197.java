...
public class DBF_DSS_F197 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 나에게맞춘간편건강보험2309 00종_맞춤간편고지3.0.5_납면적용_해약환급금지급_갱신_자유설계
    // 계약갱신주기 20년자동갱신

    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F197(), args);
    }
