...
public class DBF_DSS_F106 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 참좋은 훼밀리더블플러스종합보험2307 03종_해약환급금 지급형_납면적용(갱신종료나이)_갱신형
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F106(), args);
    }
