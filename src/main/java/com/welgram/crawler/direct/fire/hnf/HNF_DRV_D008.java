...
public class HNF_DRV_D008 extends CrawlingHNFMobile {

	// (무)하나 가득담은 운전자보험(다이렉트)(2401)
	public static void main(String[] args) {
		executeCommand(new HNF_DRV_D008(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		$button = driver.findElement(By.xpath("//div[@id='toastPop']/div[1]/div[3]/div/button"));
		click($button);
	...
	public void setTerm(String expectInsTerm, String expectedNapTerm) throws SetInsTermException {
		...
		try {
			...
			WebElement $insTermLabel = driver.findElement(By.xpath(
					// 원수사에서는 보험기간에 공백 (10 년)이 있어 translate(., ' ', '')으로 원수사 텍스트 공백 제거
					"//div[@id='divGiganInsWrapper']/label[translate(., ' ', '')='" + expectInsTerm +"']"
			));
			...
			actualInsTerm = $insTermLabel.getText().replaceAll(" ", "");
