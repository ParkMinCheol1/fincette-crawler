...
public class HWF_DSS_F158 extends CrawlingHWFAnnounce {

    // 한화 시그니처 여성 355실속간편건강보험2310 무배당 11종(기본형, 납입면제 운영형, 일반고지형) - 갱신주기 20년
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F158(), args);
    }
