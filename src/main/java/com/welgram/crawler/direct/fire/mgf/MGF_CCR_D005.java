...
public class MGF_CCR_D005 extends CrawlingMGFDirect {

    public MGF_CCR_D005() {
    }

    public static void main(String[] args) {
        executeCommand(new MGF_CCR_D005(), args);
    }
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        Optional<WebElement> elementIfExist = helper.findExistentElement(
            By.cssSelector("#confirmPopBtncheckInsAgChngDt"));
        elementIfExist.ifPresent(e -> helper.click(e, "상령일 변경 안내"));

        // 비갱신형
        logger.info("보장형태(갱신/비갱신) :: {}", info.getProductType());
        ...
        logger.info("특약 확인");
        checkTreaties(driver.findElements(By.xpath("//table[@class='compare compare02']//tr")),
            info.getTreatyList(), $tdId);
