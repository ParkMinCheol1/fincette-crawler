...
// (무) 간편해진335건강보험[3종:해약환급금미지급형Ⅱ(간편심사)]2304
public class NHF_DSS_F002 extends CrawlingNHFAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHF_DSS_F002(), args);
    }
...
//        option.setTouchEnPc(true);
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHF_DSS_F002 :: {}", info.getProductName());
        WaitUtil.waitFor(3);
