...
public class HWF_CHL_F008 extends CrawlingHWFAnnounce {

    // 무배당 한화 처음부터 함께하는 어린이보험2310 2종(납입후50%해약환급금지급형) - 부양자 모선택, 0세설계, 2종(납입후50%해약환급금지급형), 100세, 20년납, 갱신주기20년선택
    public static void main(String[] args) {
        executeCommand(new HWF_CHL_F008(), args);
    }
