...
public class HMF_ACD_F006 extends CrawlingHMFAnnounce {

	// 무배당 흥Good 폼나는 MZ보험(23.09)_(2종)(무해약 납입후 50%해약환급금지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_ACD_F006(), args);
	}
	...
	private void crawlFromAnnounce(CrawlingProduct info) throws Exception{
		...
		checkPremium2($grantPremium, 20000);
