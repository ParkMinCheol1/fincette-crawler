...
public class HMF_DSS_F061 extends CrawlingHMFAnnounce {

	// 무배당 흥국화재 든든한 355 간편종합보험(23.07)_(2종)(30년갱신형)(경증간편가입형Ⅲ)(해약환급금 미지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_DSS_F061(), args);
	}
