...
public class HNF_CHL_F006 extends CrawlingHNFNew {

	public static void main(String[] args) {
		executeCommand(new HNF_CHL_F006(), args);
	}
	...
	public void setBirthday(Object... obj) throws SetBirthdayException {
		...
		try {
			WebElement $birth = helper.waitElementToBeClickable(driver.findElement(By.id("cal_birth")));
