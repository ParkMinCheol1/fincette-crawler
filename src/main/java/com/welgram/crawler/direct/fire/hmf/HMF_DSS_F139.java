...
public class HMF_DSS_F139 extends CrawlingHMFAnnounce {

	// 무배당 흥국화재 든든한 355 간편종합보험(24.01)_(2종)(30년갱신형)(경증간편가입형Ⅲ)(해약환급금미지급형)
	public static void main(String[] args) {
		executeCommand(new HMF_DSS_F139(), args);
	}
				...
				for (CrawlingTreaty welgramTreaty : welgramTreatyList) {
					if (treatyName.equals(welgramTreaty.getTreatyName())) {
						...
						if (!exceptionText.equals("skip")) {
							helper.selectOptionContainsText(termSelect, term);
						}
