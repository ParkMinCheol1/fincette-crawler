...
public class KBF_CHL_D011 extends CrawlingKBFDirect {

    public static void main(String[] args) {
        executeCommand(new KBF_CHL_D011(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        helper.waitElementToBeClickable(By.cssSelector(".left:nth-child(3) .tit"));
        WaitUtil.waitFor(2);
        $span = driver.findElement(By.cssSelector(".left:nth-child(3) .tit"));
        click($span);
        waitLoadingBar();
        ...
        logger.info("보험기간 선택");
        String script = "return $('ul.clfix._item1')[0]";
        ...
        By premiumLocate = By.xpath("//div[@class='pc_blk_box mt_1 ng-scope']//ul[@class='pc_ver_both_wrap'][contains(., '예상만기환급금')]//li[@class='left pc_w_60 al_right']");
