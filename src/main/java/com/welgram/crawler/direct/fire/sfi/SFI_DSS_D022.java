...
public class SFI_DSS_D022 extends CrawlingSFIDirect {

	public static void main(String[] args) {
		executeCommand(new SFI_DSS_D022(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("맞춤 상품 제안에 필요한 정보를 알려주세요 팝업 모두 아니요 클릭");
		List<WebElement> $labels = driver.findElements(By.xpath("//ul[@id='notice-inner-scroll']//label[normalize-space()='아니요']"));
...
//			click($label);
		...
		$button = driver.findElement(By.xpath("//button[@log-id='btn-next-step']"));
		click($button);
		modalCheck();
