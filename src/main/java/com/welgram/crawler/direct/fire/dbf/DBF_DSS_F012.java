...
public class DBF_DSS_F012 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 내맘에참편한新3.3.5건강보험2304 (05종_자유설계_경증Ⅱ간편고지(3Q)_해약환급금미지급형_(납중0%/납후50%)_납면적용_세만기)
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F012(), args);
    }
