...
public class HWF_DSS_F128 extends CrawlingHWFAnnounce {

    // 한화 3N5 WELL100 실속간편건강보험2310 무배당(일반고지형) 5종(납입후50%해약환급금지급형, 납입면제 운영형, 일반고지형) - 100세 20년납, 갱신주기 20년
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_F128(), args);
    }
