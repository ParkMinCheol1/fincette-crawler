...
public class DBF_DSS_F015 extends CrawlingDBFAnnounce {

    // 무배당 프로미라이프 참좋은 시니어 헬스케어보장보험2301 (01종_자유설계플랜_해약환급금 지급형_ 납면미적용_갱신형)
    public static void main(String[] args) {
        executeCommand(new DBF_DSS_F015(), args);
    }
    ...
    private void crawlFromHomepage(CrawlingProduct info) throws Exception {
        ...
        for (WebElement $element : elements) {
            ...
            if (labelText.contains(info.planSubName)) {
                $label.click();
