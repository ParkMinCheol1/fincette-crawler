...
public class HWF_DSS_D010 extends CrawlingHWFDirect {

    // 한화 다이렉트 생활보장 건강보험 무배당(n년만기 갱신형)
    public static void main(String[] args) {
        executeCommand(new HWF_DSS_D010(), args);
    }
    ...
    public void setTreaties(CrawlingProduct info) throws Exception {
        ...
        for (CrawlingTreaty welgramTreaty : welgramTreaties) {
            ...
            WebElement $treatyLabel;
            try {
                $treatyLabel = $treatyNameA.findElement(By.xpath("./parent::label"));
            } catch (Exception e) {
                $treatyLabel = $treatyNameA.findElement(By.xpath("/ancestor::label"));
            }
