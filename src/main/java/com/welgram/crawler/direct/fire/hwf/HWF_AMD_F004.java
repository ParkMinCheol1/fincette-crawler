...
public class HWF_AMD_F004 extends CrawlingHWFAnnounce {

    // 참 편한 실손의료보험(간편고지, 갱신형)2310 무배당  // ** 플랜카테고리 MDC
    // 실손보험의 플랜카테고리는 유병력자 실손보험 카테고리를 사용하지 않고 있습니다 (상품 카테고리 AMD의 경우, 플랜카테고리는 유병력자가 될수 없습니다 //다만 , 보답에서 심사유형의 선택으로 유병력자 상품을 확인할 수 있습니다)
    public static void main(String[] args) {
        executeCommand(new HWF_AMD_F004(), args);
    }
