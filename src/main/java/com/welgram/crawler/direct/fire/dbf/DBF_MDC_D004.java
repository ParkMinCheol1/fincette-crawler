...
public class DBF_MDC_D004 extends CrawlingDBF {		// 무배당 프로미라이프 다이렉트 실손의료비보험1904(CM)

	

	public static void main(String[] args) {
		executeCommand(new DBF_MDC_D004(), args);
	}
	...
	public void crawlFromHomepage(CrawlingProduct info) throws Exception {
			...
			logger.info("실손보험");
			driver.findElement(By.xpath("//li[@class='li01 selectCalcPdcDvcd']")).click();
			...
			// 확인
			helper.click(By.cssSelector("#ltmJobNmChk"));
			// 완료버튼
