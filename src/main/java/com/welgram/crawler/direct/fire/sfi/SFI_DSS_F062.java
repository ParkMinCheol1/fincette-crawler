...
public class SFI_DSS_F062 extends CrawlingSFIAnnounce {

    public static void main(String[] args) {
        executeCommand(new SFI_DSS_F062(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("(Fixed)간편유형 구분 설정");
        $select = driver.findElement(By.id("c_simpDsTypCd"));
        setHealthType($select, info.getTextType());
