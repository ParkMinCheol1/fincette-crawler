...
public class SLI_MDC_F005 extends CrawlingSLIAnnounce {

    public static void main(String[] args) {
        executeCommand(new SLI_MDC_F005(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("의료수급권자 :: 일반(비대상) 선택");
        location = By.id("mdcrRcbfrYn");
        setPlan(info, location, "일반(비대상)");
