...
public class MRA_TRM_F001 extends CrawlingMRAAnnounce {

    public static void main(String[] args) {
        executeCommand(new MRA_TRM_F001(), args);
    }
...
//
//public class MRA_TRM_F001 extends CrawlingMRA {
//
//    public static void main(String[] args) {
//        executeCommand(new MRA_TRM_F001(), args);
//    }
...
////        logger.info("정기보험 클릭");
////        helper.waitPresenceOfElementLocated(By.xpath("//div[@class='submenu-box']//ul//a[text()='정기보험']"));
////        helper.waitElementToBeClickable(By.xpath("//div[@class='submenu-box']//ul//a[text()='정기보험']")).click();
////        waitLoadingImg();
////
////
...
////
////        logger.info("건강인우대 설정");
////        setHealthType(info.textType);
////
...
////            productGubun = "순수보장형";
////        } else if(info.treatyList.get(0).productKind == ProductKind.만기환급형) {
////            productGubun = "만기환급형";
////        }
////        setPlanType(productGubun);
////
////        logger.info("가입금액 설정");
...
//
//
//        logger.info("공시실 상품명 : 미래에셋생명 정기보험 무배당 클릭");
//        element = driver.findElement(By.xpath("//span[text()='미래에셋생명 정기보험 무배당']/parent::a"));
