...
public class LIN_DTL_F002 extends CrawlingLINAnnounce { // 무배당THE건강한치아보험Ⅴ

    public static void main(String[] args) {
        executeCommand(new LIN_DTL_F002(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_DTL_F002 :: {}", info.getProductName());
        WaitUtil.waitFor(1);

        // 판매채널 ( value = 20 - GA )
        logger.info("판매채널 :: {}", "20(GA)");
