...
// 당당한인생간편종신보험무배당2401(해약환급금 일부지급형(50%형))_1종(기본형)
public class DGL_WLF_F022 extends CrawlingDGLAnnounce {

    public static void main(String[] args) {
        executeCommand(new DGL_WLF_F022(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("납입기간 설정");
        driver.findElement(By.xpath("//*[@id='H81001_pypd']/option[contains(., '20년')]")).click();

        logger.info("가입금액 설정");
        int assureMoney = Integer.parseInt(info.assureMoney) / 10000;
        setTextToInputBox(By.xpath("//*[@id='H81001_SMSU_INPUT']"), String.valueOf(assureMoney));
