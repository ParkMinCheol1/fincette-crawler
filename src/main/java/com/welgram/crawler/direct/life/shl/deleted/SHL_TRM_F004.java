...
// SHL_TRM_F004         | 신한CEO정기보험(무배당, 보증비용부과형) 체증형 간편심사형
public class SHL_TRM_F004 extends CrawlingSHL {

    public static void main(String[] args) {
        executeCommand(new SHL_TRM_F004(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("START :: 신한CEO정기보험(무배당, 보증비용부과형) 평준형 간편심사형");
...
//        WebElement alert1 = driver.findElement(By.xpath("//div[@class='popCont alert']"));
//        if(alert1.isDisplayed()) {
//            logger.info(" ::: ALERT TEXT ::: ");
//            logger.info(alert1.getText());
//            helper.doClick(By.xpath("//button[@id='popupBtn2']"));
//            WaitUtil.waitFor(2);
//        } else {
//            logger.info("THERE IS NO ALERT!! ");
//        }
...
//        js.executeScript("document.querySelector('#mnprDivision > ul:nth-child(2) > li:nth-child(3) > div.val > div > input').value = '';");
        js.executeScript("$(arguments[0]).value = '';", inputTextJoinFee);
...
//        WebElement alert2 = driver.findElement(By.xpath("//div[@class='popCont alert']"));
//        if(alert2.isDisplayed()) {
//            logger.info(alert2.getText() + "111111111111");
//            helper.doClick(By.xpath("//button[@id='popupBtn2']"));
//            WaitUtil.waitFor(2);
//        } else {
//            logger.info(alert2.getText() + "2222222222222");
//        }
