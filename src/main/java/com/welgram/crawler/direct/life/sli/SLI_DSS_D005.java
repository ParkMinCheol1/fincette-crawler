...
public class SLI_DSS_D005 extends CrawlingSLIAnnounce {
//public class SLI_DSS_D005 extends CrawlingSLIMobile {
// 23.08.21 모바일에 문제가 있어 공시실로 전환

    public static void main(String[] args) {
        executeCommand(new SLI_DSS_D005(), args);
    }
...
//        crawlingMobile(info);
    ...
    public void setRadioButtonAssureMoney(Object obj) throws SetAssureMoneyException {
        ...
        try{
            //23.04.27
            //info에 grt의 정보가 없어 특정 label선택으로 진행 mincheol
            $label = driver.findElement(By.xpath("//label[@for='rangeAmt12']"));
            click($label);
        } catch (Exception e) {
