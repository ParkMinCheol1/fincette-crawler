...
// 2023.11.07 | 최우진 | (무)수호천사NEW알뜰플러스종신-금리확정형(평준납입형)-(해약환급금일부지급형)체증형
public class TYL_WLF_F026 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_WLF_F026(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_G6CP21AA0']/div/p/span[1]/b";
