...
// 2023.07.25 | 최우진 | 신한케어받는간편가입치매간병보험(무배당)(일반심사형)(1년보증형)일반형
public class SHL_DMN_F008 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_DMN_F008(), args); }
