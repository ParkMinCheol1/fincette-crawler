...
// 2023.08.04 | 최우진 | 무배당 AIA 안심+ 프라임 종신보험 (해약환급금 50%지급형) 2형(일반심사형)
public class AIL_WLF_F007 extends CrawlingAILAnnounce {

    public static void main(String[] args) { executeCommand(new AIL_WLF_F007(), args); }
    ...
    public void innerScrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("START :: AIL_WLF_F006 :: 무배당 AIA 안심+ 프라임 종신보험 (해약환급금 50%지급형) 2형(일반심사형)");
        ...
        setInsTerm(driver.findElement(By.xpath("//*[@id='polprd_T40102_01C']")), info.getInsTerm());
        setNapTerm(driver.findElement(By.id("payprd_T40102_01C")), info.getNapTerm(), info.getInsTerm());
        setNapCycle(driver.findElement(By.xpath("//*[@name='payCyclCd']")), info.getNapCycleName());
        setAssureMoney(driver.findElement(By.xpath("//*[@name='sfaceAmt_T40102_01C']")), info.getAssureMoney(), unitGJ);
