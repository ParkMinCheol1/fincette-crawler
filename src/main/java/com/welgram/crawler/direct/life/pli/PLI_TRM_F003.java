...
public class PLI_TRM_F003 extends CrawlingPLI {

    public static void main(String[] args) { executeCommand(new PLI_TRM_F003(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("상품명 선택");
        selectByVisibleTxt("[@id='selProductist']", "무배당 푸르덴셜 경영인정기보험");

        logger.info("상세 상품명 선택");
        selectByVisibleTxt("[@id='selProductistDetail']", info.textType);
