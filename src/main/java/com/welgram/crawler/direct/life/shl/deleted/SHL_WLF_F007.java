...
// SHL_WLF_F007         | 신한더드림종신보험(무배당, 해약환급금 일부지급형) 일반
public class SHL_WLF_F007 extends CrawlingSHL {



    public static void main(String[] args) {
        executeCommand(new SHL_WLF_F007(), args);
    }
...
//        logger.info("START :: SHL_WLF_F007 :: 신한더드림종신보험(무배당, 해약환급금 일부지급형) 일반");
