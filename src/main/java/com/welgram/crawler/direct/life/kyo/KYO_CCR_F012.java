...
// 2023.11.28 | 최웅진 | 교보간편가입암보험(무배당,갱신형)
public class KYO_CCR_F012 extends CrawlingKYOAnnounce {

    public static void main(String[] args) { executeCommand(new KYO_CCR_F012(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        setInsTerm(driver.findElement(By.xpath("//*[@id='5199800_isPd']")), info.getInsTerm(), 2);
        setAssureMoney(driver.findElement(By.xpath("//*[@id='5199800_sbcAmt']")), info.getAssureMoney(), 2);
        setNapCycle(driver.findElement(By.xpath("//*[@id='pdtMcrnCd_paCyc']")), info.getNapCycleName(), 2);
        setNapTerm(
            driver.findElement(By.xpath("//*[@id='5199800_paPd']")),
            info.getNapTerm(),
            info.getInsTerm(),
            2,
            false
