...
public class LIN_DSS_D002 extends CrawlingLINMobile { // 무배당 건강검진 걱정없는 미니보험

    public static void main(String[] args) {
        executeCommand(new LIN_DSS_D002(), args);
    }
    ...
    private void mobileCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_DSS_D002 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
        ...
        helper.moveToElementByJavascriptExecutor(driver.findElement(by));
        WaitUtil.waitFor(1);
        btnClick(by, 2);
