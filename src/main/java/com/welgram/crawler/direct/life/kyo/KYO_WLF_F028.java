...
// 2023.06.28 | 최우진 | 교보실속종신보험(무배당,보증비용부과형)
public class KYO_WLF_F028 extends CrawlingKYOAnnounce {

	public static void main(String[] args) { executeCommand(new KYO_WLF_F028(), args); }
