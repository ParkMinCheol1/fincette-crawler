...
// TYL_TRM_F016         | (무)수호천사VIP플러스정기(간편심사형-표준형-기본형)
public class TYL_TRM_F016 extends CrawlingTYL {

    public static void main(String[] args) {
        executeCommand(new TYL_TRM_F016(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("주상품 설정");
        setPlanType("(무)수호천사VIP플러스정기(간편심사형-표준형-기본형)");       // 20% 체증 고정
