...
// 2023.07.06 | 최우진 | 신한평생간병비걱정없는뇌심혈관보험(무배당,해약환급금일부지급형)
public class SHL_DSS_F011 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_DSS_F011(), args); }
