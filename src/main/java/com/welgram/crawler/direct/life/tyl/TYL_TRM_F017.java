...
// TYL_TRM_F017         | (무)수호천사VIP플러스정기(간편심사형-표준형-체증형)
public class TYL_TRM_F017 extends CrawlingTYL {

    public static void main(String[] args) {
        executeCommand(new TYL_TRM_F017(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("주상품 설정");
        setPlanType("(무)수호천사VIP플러스정기(간편심사형-표준형-20%체증형)");
