...
public class PLI_TRM_F004 extends CrawlingPLI {

    public static void main(String[] args) { executeCommand(new PLI_TRM_F004(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("상품명 선택");
        selectByVisibleTxt("[@id='selProductist']", "무배당 푸르덴셜 간편한 경영인정기보험");

        logger.info("상세 상품명 선택");
        selectByVisibleTxt("[@id='selProductistDetail']", "무배당 푸르덴셜 간편한 경영인정기보험(15% 체증형)");
        ...
        logger.info("성별");
        helper.click(By.xpath(("//select[@id='strGender']//option[@value='"
            + (info.gender + 1) + "']")));
