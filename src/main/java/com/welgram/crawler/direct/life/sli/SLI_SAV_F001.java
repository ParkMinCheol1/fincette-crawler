...
public class SLI_SAV_F001 extends CrawlingSLIAnnounce {

	public static void main(String[] args) {
		executeCommand(new SLI_SAV_F001(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info(" 고액계약 :: 고액적립 선택");
		location = By.id("lgatContAppnCd");
		setPlan(info, location, "고액적립");
