...
public class LIN_DMN_F014 extends CrawlingLINAnnounce { // 무배당전에없던실속치매보험(해약환급금미지급형)

    public static void main(String[] args) {
        executeCommand(new LIN_DMN_F014(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_DMN_F014 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
