...
public class AIL_DSS_F005 extends CrawlingAILAnnounce {

    // (무)AIA Vitality 내가 조립하는 종합건강보험II 2형(일반심사형)
    public static void main(String[] args) { executeCommand(new AIL_DSS_F005(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        setInsTerm(driver.findElement(By.xpath("//*[@id='polprd_Q10102_01C']")), info.getInsTerm());
        setNapTerm(driver.findElement(By.xpath("//*[@id='payprd_Q10102_01C']")), info.getNapTerm(), info.getInsTerm());
