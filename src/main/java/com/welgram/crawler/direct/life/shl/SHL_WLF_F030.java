...
// SHL_WLF_F030         | 신한더드림종신보험(무배당, 해약환급금 일부지급형)
public class SHL_WLF_F030 extends CrawlingSHL {

    public static void main(String[] args) { executeCommand(new SHL_WLF_F030(), args); }

    @Override
    protected boolean scrap(CrawlingProduct info) throws Exception {

        logger.info("START :: 신한더드림종신보험(무배당, 해약환급금 일부지급형)");
        ...
        try {
            ...
            selctInsForm.selectByVisibleText("일반심사형");               // SHL_WLF_F030의 대표가설은 일반심사형입니다
            WaitUtil.loading(2);
