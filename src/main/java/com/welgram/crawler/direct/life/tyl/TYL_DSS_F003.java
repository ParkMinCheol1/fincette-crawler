...
// 2023.06.09 | 최우진 | 무배당수호천사건강검진주요양성종양수술보험
// submitTreatiesInfo
// submitMainProduct
public class TYL_DSS_F003 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_DSS_F003(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        submitMainProduct(driver.findElement(By.id("policycd_l")), mainProductTitle);
        pushButton("특약 조회", 3);

        logger.info("▉▉▉▉ [03] 특약을 선택해 주세요 ▉▉▉▉");
        submitTreatiesInfo(driver.findElements(By.xpath("//*[@id='step3_tbody1']/tr")), treatyList);
        pushButton("보험료 계산", 5);
