...
public class NHL_ASV_F002 extends CrawlingNHLAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHL_ASV_F002(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String genderText1 = (info.getGender() == MALE) ? "남" : "여";
        ...
        logger.info("성별 :: {}", genderText1);
        setGender(By.xpath("//label[@for='" + genderOpt + "']"), genderText1);
