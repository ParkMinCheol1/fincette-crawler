...
// 2023.07.14 | 최우진 | 교보실속간편가입종신보험(무배당,보증비용부과형) (저해약환급금형, 기본형플러스)
public class KYO_WLF_F035 extends CrawlingKYOAnnounce {

    public static void main(String[] args) { executeCommand(new KYO_WLF_F035(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        setInsTerm(driver.findElement(By.xpath("//*[@id='5186504_isPd']")), info.getInsTerm(), 2);
        setAssureMoney(driver.findElement(By.xpath("//*[@id='5186504_sbcAmt']")), info.getAssureMoney(), 2);
        setNapCycle(driver.findElement(By.xpath("//*[@id='pdtMcrnCd_paCyc']")), info.getNapCycleName(), 2);
        setNapTerm(driver.findElement(By.xpath("//*[@id='5186504_paPd']")), info.getNapTerm(), info.getInsTerm(), 2, false);
