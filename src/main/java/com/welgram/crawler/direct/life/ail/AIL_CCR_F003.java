...
// 2023.06.02 | 최우진 | 무배당 AIA 건강+ 암보험(갱신형) 1형(간편심사형)
public class AIL_CCR_F003 extends CrawlingAILAnnounce {

    public static void main(String[] args) {
        executeCommand(new AIL_CCR_F003(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        // 주계약
        setInsTerm(driver.findElement(By.xpath("//*[@id='polprd_Q90101_02C']")), info.getInsTerm());
        setNapTerm(driver.findElement(By.xpath("//*[@id='payprd_Q90101_02C']")), info.getNapTerm(), info.getInsTerm());
        ...
        pushButton(By.xpath("//button[text()='보험료 계산하기']"), 5);                   // 보험료 계산하기
