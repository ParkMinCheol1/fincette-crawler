...
// AIL_TRM_F003         | (무)AIA 경영인을 위한 안심+ 정기보험 (일반심사) 15%
public class AIL_TRM_F003 extends CrawlingAILAnnounce {

    public static void main(String[] args) { executeCommand(new AIL_TRM_F003(), args); }



    @Override
    public boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("▉▉▉▉ 주계약 ▉▉▉▉");
        setInsTerm(driver.findElement(By.xpath("//*[@id='polprd_DN0122_01D']")), info.getInsTerm());
        setNapTerm(driver.findElement(By.xpath("//*[@id='payprd_DN0122_01D']")), info.getNapTerm(), info.getInsTerm());
