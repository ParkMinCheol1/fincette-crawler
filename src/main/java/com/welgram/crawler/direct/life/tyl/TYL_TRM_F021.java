...
// 2023.07.31 | 최우진 | (무)수호천사경영인정기보험(보증비용부과형) (최저해약환급금 보증형-15%체증형)
public class TYL_TRM_F021 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_TRM_F021(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_M93921BA2']/div/p/span[1]/b";
