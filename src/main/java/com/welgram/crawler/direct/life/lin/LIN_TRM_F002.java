...
public class LIN_TRM_F002 extends CrawlingLINAnnounce { // 무배당THE간편고지정기보험(갱신형)

    public static void main(String[] args) {
        executeCommand(new LIN_TRM_F002(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_TRM_F002 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
