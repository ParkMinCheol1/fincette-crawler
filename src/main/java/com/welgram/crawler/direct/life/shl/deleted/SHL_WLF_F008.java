...
// SHL_WLF_F008         | 신한멋진종신보험v2.0(무배당, 해약환급금 일부지급형) 라이트형
public class SHL_WLF_F008 extends CrawlingSHL {

    public static void main(String[] args) {
        executeCommand(new SHL_WLF_F008(), args);
    }

    @Override
    protected boolean scrap(CrawlingProduct info) throws Exception {
        logger.info("START :: SHL_WLF_F008 :: 신한멋진종신보험v2.0(무배당, 해약환급금 일부지급형) 라이트형");
