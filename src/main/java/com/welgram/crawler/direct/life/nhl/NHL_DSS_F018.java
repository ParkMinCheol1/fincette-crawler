...
/**
 * 상품명 : 9988NH건강보험(갱신형,무배당)_2301
 * 상품유형 : 1형(간편가입형)건강관리형
 * 웹 크롤링으로 진행
 *
 */
public class NHL_DSS_F018 extends CrawlingNHLAnnounce {



	public static void main(String[] args) {

		executeCommand(new NHL_DSS_F018(), args);
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHL_DSS_F018 :: {}", info.getProductName());
		WaitUtil.waitFor(2);
