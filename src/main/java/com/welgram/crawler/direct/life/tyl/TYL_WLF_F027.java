...
// 2023.11.07 | 최우진 | (무)수호천사NEW간편한알뜰플러스종신-간편심사형(0)-금리확정형(평준납입형-표준형)
public class TYL_WLF_F027 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_WLF_F027(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_O63Q21AA0']/div/p/span[1]/b";
