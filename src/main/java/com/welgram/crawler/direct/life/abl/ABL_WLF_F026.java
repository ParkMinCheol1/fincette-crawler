...
public class ABL_WLF_F026 extends CrawlingABLAnnounce {

    public static void main(String[] args) {
        executeCommand(new ABL_WLF_F026(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        // 주보험 비교 -> (무)ABL건강하면THE소중한종신보험(해약환급금 일부지급형)2304 서브네임:3종(체증형) / 텍스트타입:기본형_FC
