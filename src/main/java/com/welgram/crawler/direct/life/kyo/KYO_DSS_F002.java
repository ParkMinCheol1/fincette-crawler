...
// 20230.04.26              | 최우진                   | 대면_질병
// KYO_DSS_F002             | (무)교보내맘쏙건강보험
public class KYO_DSS_F002 extends CrawlingKYO {

    public static void main(String[] args) { executeCommand(new KYO_DSS_F002(), args); }
