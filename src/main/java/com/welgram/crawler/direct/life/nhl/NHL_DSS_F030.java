...
/**
 * 백세팔팔NH건강보험(무배당) 2형(일반가입) 순수보장형
 *
 * 웹 크롤링으로 진행
 *
 */
public class NHL_DSS_F030 extends CrawlingNHLAnnounce {


	public static void main(String[] args) {
		executeCommand(new NHL_DSS_F030(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHL_DSS_F030 :: {}", info.getProductName());
		WaitUtil.waitFor(2);
