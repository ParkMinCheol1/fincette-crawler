...
// 2023.08.27 | 최우진 | (무)꿈나무우리아이보험(만기환급형-자유설계형)
public class TYL_CHL_F002 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_CHL_F002(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_9WY521AF6']/div/p/span[1]/b";
