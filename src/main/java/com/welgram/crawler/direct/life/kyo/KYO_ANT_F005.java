...
// 2023.06.22 | 최우진 |
public class KYO_ANT_F005 extends CrawlingKYOAnnounce {
    

    public static void main(String[] args) {
        executeCommand(new KYO_ANT_F005(), args);
    }
...
//        String whl10y = driver.findElement(By.cssSelector("#anXmplRview > div:nth-child(8) > table > tbody > tr:nth-child(1) > td:nth-child(2)")).getText()+unitText;
//        String whl20y = driver.findElement(By.cssSelector("#anXmplRview > div:nth-child(8) > table > tbody > tr:nth-child(1) > td:nth-child(3)")).getText()+unitText;
//        String whl30y = driver.findElement(By.cssSelector("#anXmplRview > div:nth-child(8) > table > tbody > tr:nth-child(1) > td:nth-child(4)")).getText()+unitText;
//        String whl100a = driver.findElement(By.cssSelector("#anXmplRview > div:nth-child(8) > table > tbody > tr:nth-child(1) > td:nth-child(5)")).getText()+unitText;
//
