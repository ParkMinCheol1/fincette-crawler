...
// 2023.08.03 | 최우진 | 신한CEO정기보험II(무배당, 보증비용부과형) 1종(간편심사형)(10%)체증형
public class SHL_TRM_F019 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_TRM_F019(), args); }
