...
public class KBL_CCR_F005 extends CrawlingKBLAnnounce {

    public static void main(String[] args) {
        executeCommand(new KBL_CCR_F005(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        setSelectBoxNapCycle(getNapCycleName(info.getNapCycle()), location, script);
        ...
        logger.info("해약환급금");
        String[] targetPageList = new String[]{"6","7","8","9"};
