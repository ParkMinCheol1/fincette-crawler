...
// 2023.07.14 | 최우진 | 교보실속종신보험(무배당,보증비용부과형) 저해약환급금형,기본형플러스
public class KYO_WLF_F038 extends CrawlingKYOAnnounce {

    public static void main(String[] args) { executeCommand(new KYO_WLF_F038(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("▉▉▉▉ 주계약 ▉▉▉▉");
        setDiscountOption(
            driver.findElement(By.xpath("//*[@id='radio-c1']/parent::label")),
            driver.findElement(By.xpath("//*[@id='radio-c2']/parent::label")),
            discountOption,
            5
        );
        setProductKind(driver.findElement(By.xpath("//*[@id='sel_gdcl']")), textType[2], 3);
        setInsTerm(driver.findElement(By.xpath("//*[@id='5182902_isPd']")), info.getInsTerm(), 2);
        setAssureMoney(driver.findElement(By.xpath("//*[@id='5182902_sbcAmt']")), info.getAssureMoney(), 2);
        setNapCycle(driver.findElement(By.xpath("//*[@id='pdtMcrnCd_paCyc']")), info.getNapCycleName(), 2);
        setNapTerm(driver.findElement(By.xpath("//*[@id='5182902_paPd']")), info.getNapTerm(), info.getInsTerm(), 2, false);
