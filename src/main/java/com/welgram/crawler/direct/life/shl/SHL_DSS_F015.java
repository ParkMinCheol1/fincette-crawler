...
// 2023.08.20 | 최우진 | 신한진심을품은보장보험(무배당, 해약환급금 미지급형) 기본형(미부가형)
public class SHL_DSS_F015 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_DSS_F015(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        setTreatyList2(driver.findElements(By.xpath("//*[@id='trtyDivision']/table/tbody/tr")), info.getTreatyList(), arrTextType);
