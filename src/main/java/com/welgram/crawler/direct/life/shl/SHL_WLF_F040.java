...
// 2023.07.18 | 최우진 | 신한간편가입더드림종신보험(무배당, 해약환급금 일부지급형)
public class SHL_WLF_F040 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand( new SHL_WLF_F040(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("▉▉▉▉ 보험형태, 보험기간, 직종구분, 납입기간, 납입주기, 가입금액 ▉▉▉▉");
