...
// 2023.08.23 | 최우진 | (무)꿈나무우리아이보험(만기환급형-자유설계형)_태아보장기간
public class TYL_BAB_F001 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_BAB_F001(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String floatingTreatyName = "(무)꿈나무우리아이보험(만기환급형-자유설계형)_태아적립";
        ...
        crawlReturnMoneyList(
            driver.findElements(By.xpath("/html/body/div/div/div/div[71]/table/tbody/tr")),
            info,
            refundOption
        );
