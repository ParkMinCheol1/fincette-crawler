...
public class LIN_DMN_F002 extends CrawlingLINAnnounce { // 무배당라이나간병플러스치매보험2종(순수보장형)실속형

    public static void main(String[] args) {
        executeCommand(new LIN_DMN_F002(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_DMN_F002 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
