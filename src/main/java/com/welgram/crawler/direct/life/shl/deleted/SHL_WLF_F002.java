...
// 2022.07.18           | 최우진               | 대면_종신보험
// SHL_WLF_F002         | 신한간편가입용감한종신보험(무배당, 해약환급금 일부지급형) 일반형
public class SHL_WLF_F002 extends CrawlingSHL {



    public static void main(String[] args) {
        executeCommand(new SHL_WLF_F002(), args);
    }

    @Override
    protected boolean scrap(CrawlingProduct info) throws Exception {
        logger.info("START :: SHL_WLF_F002 :: 신한간편가입용감한종신보험(무배당, 해약환급금 일부지급형) 일반형");
        ...
        for(int i = 0; i < arrTType.length; i++) {
            ...
            // 0 : 신한간편가입용감한종신보험(무배당, 해약환급금 일부지급형)
            // 1 : 일반형
            // 2 :
        }
        WaitUtil.loading(2);
