...
public class TYL_DSS_F009 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_DSS_F009(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_E27821AC0']/div/p/span[1]/b";
