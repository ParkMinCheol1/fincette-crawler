...
public class LIN_WLF_F011 extends CrawlingLINAnnounce { // 무배당전에없던초간편종신보험(해약환급금미지급형)_가입금액형

    public static void main(String[] args) {
        executeCommand(new LIN_WLF_F011(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_WLF_F011 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
