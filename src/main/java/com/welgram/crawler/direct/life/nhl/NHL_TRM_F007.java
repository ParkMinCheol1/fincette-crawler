...
public class NHL_TRM_F007 extends CrawlingNHLAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHL_TRM_F007(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHL_TRM_F007 :: {}", info.getProductName());
        WaitUtil.waitFor(2);
        ...
        String getinsTerm = info.getInsTerm() + "만기";
        setInsTerm(By.id("strSurPrdCod_4_0"), getinsTerm);

        logger.info("납입기간 :: {}", info.getNapTerm());
        String getNapTerm = info.getNapTerm() + "납";
        setNapTerm(By.id("strNabPrdCod_4_0"), getNapTerm);
