...
public class CBL_WLF_F016 extends CrawlingCBLAnnounce {

    public static void main(String[] args) {
        executeCommand(new CBL_WLF_F016(), args);
    }
    ...
    public void setMainTreaty(CrawlingTreaty mainTreaty) throws SetTreatyException {
        ...
        try {
            WebElement $treatyNameTd = driver.findElement(By.xpath("//td[normalize-space()='" + "Chubb 간편가입 New 수(秀) 종신보험 무배당(해약환급금 일부지급형)" + "']"));
