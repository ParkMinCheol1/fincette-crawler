...
/**
 * 백세팔팔NH건강보험(갱신형,무배당) 1형(간편가입형Ⅱ) 건강관리형
 *
 * 웹 크롤링으로 진행
 *
 */
public class NHL_DSS_F025 extends CrawlingNHLAnnounce {



	public static void main(String[] args) {

		executeCommand(new NHL_DSS_F025(), args);
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHL_DSS_F025 :: {}", info.getProductName());
		WaitUtil.waitFor(2);
