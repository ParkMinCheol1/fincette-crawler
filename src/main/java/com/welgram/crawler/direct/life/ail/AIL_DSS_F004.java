...
// 2023.06.20 | 최우진 | 무배당 AIA Vitality 예방부터 케어까지 건강보험(갱신형) 2형(일반심사형)
public class AIL_DSS_F004 extends CrawlingAILAnnounce {

    public static void main(String[] args) { executeCommand(new AIL_DSS_F004(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("▉▉▉▉ 주계약 ▉▉▉▉");
        setInsTerm(driver.findElement(By.xpath("//*[@id='polprd_P501V2_02J']")), info.getInsTerm());
        setNapTerm(driver.findElement(By.xpath("//*[@id='payprd_P501V2_02J']")), info.getNapTerm(), info.getInsTerm());
        ...
        pushButton(By.xpath("//button[text()='상품제안서 보기']"), 5); // 보험료 계산하기
