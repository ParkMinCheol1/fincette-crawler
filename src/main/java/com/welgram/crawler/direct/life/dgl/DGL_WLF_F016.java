...
public class DGL_WLF_F016 extends CrawlingDGLAnnounce {

    public static void main(String[] args) {
        executeCommand(new DGL_WLF_F016(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("특약 설정");
        driver.findElement(By.xpath("//*[@id='H80201_pypd']/option[5]")).click();

        int assureMoney = Integer.parseInt(info.assureMoney) / 10000;
        setTextToInputBox(By.xpath("//*[@id='H80201_SMSU_INPUT']"), String.valueOf(assureMoney));
