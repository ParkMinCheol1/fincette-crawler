...
public class DGL_WLF_F001 extends CrawlingDGLAnnounce {

    public static void main(String[] args) {
        executeCommand(new DGL_WLF_F001(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        // SMART유니버셜종신보험 무배당 2204(보증비용부과형)_1종(기본형)
        ...
        logger.info("특약 설정");
        driver.findElement(By.xpath("//*[@id='GI4001_pypd']/option[text()='20년']")).click();
        WebElement $assureMoney = driver.findElement(By.xpath("//*[@id='GI4001_SMSU_INPUT']"));

        int assureMoney = Integer.parseInt(info.assureMoney) / 10000;
        setTextToInputBox(By.xpath("//*[@id='GI4001_SMSU_INPUT']"), String.valueOf(assureMoney));
