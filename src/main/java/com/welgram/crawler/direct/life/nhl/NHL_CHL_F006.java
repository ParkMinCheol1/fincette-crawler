 ...
 * 상품유형 : 2종(100세만기)2형(100%환급형)일반형
 * 웹 크롤링으로 진행
 *
 */
public class NHL_CHL_F006 extends CrawlingNHLAnnounce {


	public static void main(String[] args) {
		executeCommand(new NHL_CHL_F006(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHL_CHL_F006 :: {}", info.getProductName());
