...
public class TYL_DSS_F004 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_DSS_F004(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_M53321AD0']/div/p/span[1]/b";
        ...
        crawlReturnMoneyList(
            driver.findElements(By.xpath("/html/body/div/div/div/div[17]/table/tbody/tr")),
            info,
            refundOption
        );
