...
public class LIN_CCR_F006 extends CrawlingLINAnnounce { // 무배당간편고지역시라이나암보험(갱신형)_1형(감액없음)

    public static void main(String[] args) {
        executeCommand(new LIN_CCR_F006(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_CCR_F006 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
