...
// 2023.08.03 | 최우진 | 신한CEO정기보험II(무배당, 보증비용부과형) 2종(일반심사형)(20%)체증형
public class SHL_TRM_F024 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_TRM_F024(), args); }

    @Override
    protected boolean scrap(CrawlingProduct info) throws Exception {

        // INFORMATION
        String prodKind = "20%체증형";
        ...
        logger.info("▉▉▉▉ 보험형태, 보험종류, 직종구분, 납입주기, 보험기간, 납입기간, 가입금액 ▉▉▉▉");
        ...
        helper.selectByText_check(By.xpath("//select[@title='직종구분']"), "개인계약");
