...
public class NHL_ACD_D001 extends CrawlingNHLDirect {

    // 로거
    public final static Logger logger = LoggerFactory.getLogger(NHL_ACD_D001.class);

    // 구동부
    public static void main(String[] args) { executeCommand(new NHL_ACD_D001(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHL_ACD_D001 :: {}", info.getProductName());
        WaitUtil.waitFor(2);
        ...
        crawlReturnMoneyList(info, By.cssSelector("#safeReturn_uiPOPRefund1 > table > tbody > tr"));
