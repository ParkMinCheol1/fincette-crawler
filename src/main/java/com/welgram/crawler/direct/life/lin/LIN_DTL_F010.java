...
// LIN_DTL_F010 :: 무배당THE든든한실버치아보험
public class LIN_DTL_F010 extends CrawlingLINAnnounce {

    public static void main(String[] args) {
        executeCommand(new LIN_DTL_F010(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_DTL_F010 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
