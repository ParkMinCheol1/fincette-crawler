...
// 2023.04.24 | 최우진 | (무)수호천사경영인정기(보증비용부과형)-(최저해약환급금 보증형-20%체증형)
public class TYL_TRM_F018 extends CrawlingTYLAnnounce {

    public static void main(String[] args) {
        executeCommand(new TYL_TRM_F018(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_M94021BA2']/div/p/span[1]/b";
...
//            findInsuFromAnnounce("무배당수호천사경영인정기보험(보증비용부과형)");
//
//            logger.info("이름 설정");
...
//
//            logger.info("주상품 설정");
//            setPlanType("(무)수호천사경영인정기(보증비용부과형)-(최저해약환급금 보증형-20%체증형)");
//
