...
/**
 * 상품명 : 9988NH건강보험(갱신형,비갱신형,무배당)_2301
 * 상품유형 : 9988NH건강보험(갱신형,무배당)_2301 2형(일반가입형)
 * 웹 크롤링으로 진행
 *
 */
public class NHL_DSS_F013 extends CrawlingNHLAnnounce {



	public static void main(String[] args) {

		executeCommand(new NHL_DSS_F013(), args);
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHL_DSS_F013 :: {}", info.getProductName());
		WaitUtil.waitFor(2);
