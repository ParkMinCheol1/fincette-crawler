...
// SHL_WLF_F016         | 신한테이스티유니버설종신보험(무배당, 보증비용부과형) 평준형_1종(보증형)
public class SHL_WLF_F016 extends CrawlingSHL {

    public static void main(String[] args) {
        executeCommand(new SHL_WLF_F016(), args);
    }

    @Override
    protected boolean scrap(CrawlingProduct info) throws Exception {
        logger.info("START :: SHL_WLF_F016 :: 신한테이스티유니버설종신보험(무배당, 보증비용부과형) 평준형_1종(보증형)");
