...
public class KYO_DTL_F001 extends CrawlingKYO {

	public static void main(String[] args) {
		executeCommand(new KYO_DTL_F001(), args);
	}
	...
	private void doCrawlInsurancePublic(CrawlingProduct info) throws Exception {
		...
		helper.click(driver.findElement(By.cssSelector("#contents > div.ut-tabs.h > ul > li:nth-child(2) > a")));
...
//			}
//		}
		planName = "(무)교보치아보장보험(갱신형)1형(15세~65세)[최초,만기지급형]";
