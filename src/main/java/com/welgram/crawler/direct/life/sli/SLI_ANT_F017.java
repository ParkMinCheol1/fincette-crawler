...
public class SLI_ANT_F017 extends CrawlingSLIAnnounce {

	public static void main(String[] args) {
		executeCommand(new SLI_ANT_F017(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		setInsTerm(info.getAnnuityAge(), By.id("insrPrdTypValCd_A070001A03"));

		logger.info("주계약 납입기간 설정");
		setNapTerm(info.getNapTerm(), By.id("padPrd_A070001A03"));

		logger.info("주계약 보험료(가입금액) 설정");
		setAssureMoney(info.getAssureMoney(), By.id("price_A070001A03"));
