...
/**
 * 두개만묻는NH건강보험(갱신형,무배당) 2형(일반가입형)
 *
 * 웹 크롤링으로 진행
 *
 */
public class NHL_DSS_F016 extends CrawlingNHLAnnounce {


	public static void main(String[] args) {
		executeCommand(new NHL_DSS_F016(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHL_DSS_F016 :: {}", info.getProductName());
		WaitUtil.waitFor(2);
	...
	protected void setTreaties(List<CrawlingTreaty> welgramTreatyList) throws SetTreatyException {
		...
		try{
			...
			for (CrawlingTreaty welgramTreaty : welgramTreatyList) {
				...
				String treatyName1 = wTreatyName.substring(3, welgramTreaty.treatyName.indexOf("2") - 1);
