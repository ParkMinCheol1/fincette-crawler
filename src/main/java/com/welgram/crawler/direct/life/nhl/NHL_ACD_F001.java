...
// New삼천만인NH재해보험(무배당)_2301
public class NHL_ACD_F001 extends CrawlingNHLAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHL_ACD_F001(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHL_ACD_F001 :: {}", info.getProductName());
        WaitUtil.waitFor(2);
        ...
        logger.info("상품유형 :: {}", info.getPlanName());
        setPlanType(By.id("prodTpcd"), info.getPlanName());
