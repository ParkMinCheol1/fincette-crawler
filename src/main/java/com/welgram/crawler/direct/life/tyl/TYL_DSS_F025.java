...
public class TYL_DSS_F025 extends CrawlingTYLAnnounce {

    // (무)수호천사누구나필요한수술치료보험(일반심사형) 표준형
    public static void main(String[] args) { executeCommand(new TYL_DSS_F025(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_P50321AA2']/div/p/span[1]/b";
