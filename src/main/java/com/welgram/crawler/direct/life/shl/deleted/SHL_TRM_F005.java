...
// SHL_TRM_F005         | 신한The프리미엄정기보험Ⅱ(무배당)(일반심사형) 체증형
public class SHL_TRM_F005 extends CrawlingSHL {

    public static void main(String[] args) {
        executeCommand(new SHL_TRM_F005(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("START | SHL_TRM_F005 :: 신한The프리미엄정기보험Ⅱ(무배당)(일반심사형) 체증형");
