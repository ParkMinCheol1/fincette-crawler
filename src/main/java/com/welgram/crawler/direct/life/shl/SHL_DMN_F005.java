...
// SHL_DMN_F005         | 신한케어받는간편가입치매간병보험(무배당, 해약환급금 미지급형)(간편심사형)
public class SHL_DMN_F005 extends CrawlingSHL {

    public static void main(String[] args) { executeCommand(new SHL_DMN_F005(), args); }
...
//        String[] arrTextType = checkTextType(info);
        ...
        // PROCESS
        logger.info("START :: 신한케어받는간편가입치매간병보험");
