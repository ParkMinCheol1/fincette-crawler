...
public class LIN_WLF_F005 extends CrawlingLINAnnounce { // 무배당THE건강해지는종신보험(기본형)_가입금액형

    public static void main(String[] args) {
        executeCommand(new LIN_WLF_F005(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_WLF_F005 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
