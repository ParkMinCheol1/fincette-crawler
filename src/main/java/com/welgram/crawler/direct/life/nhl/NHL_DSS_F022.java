...
/**
 * 상품명 : 9988NH건강보험(무배당)_2301
 * 상품유형 : 2형(일반가입형)순수보장형
 * 웹 크롤링으로 진행
 *
 */
public class NHL_DSS_F022 extends CrawlingNHLAnnounce {


	public static void main(String[] args) {
		executeCommand(new NHL_DSS_F022(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHL_DSS_F022 :: {}", info.getProductName());
		WaitUtil.waitFor(2);
