...
public class HNL_WLF_F008 extends CrawlingHNLAnnounce {

    

    public static void main(String[] args) {
        executeCommand(new HNL_WLF_F008(), args);
    }
...
//            click($productTypeBtn);
            ...
            WebElement $productTypeBtn = $productTypeSpan.findElement(By.xpath("//*[@id=\"pdtBtn_436511\"]"));
            click($productTypeBtn);
