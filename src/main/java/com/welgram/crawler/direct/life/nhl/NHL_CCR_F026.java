...
public class NHL_CCR_F026 extends CrawlingNHLAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHL_CCR_F026(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHL_CCR_F026 :: {}", info.getProductName());
        WaitUtil.waitFor(2);

        // 상품유형 먼저 진행 시 셀렉트박스 나타나지 않는 현상으로 인해 생년월일 2번 진행
