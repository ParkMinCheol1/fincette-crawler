...
public class KYO_DSS_F008 extends CrawlingKYOAnnounce2 {

    public static void main(String[] args) {
        executeCommand(new KYO_DSS_F008(), args);
    }
...
//
//
//// 2023.07.05 | 최우진 | (무)교보간편해요건강보험
//public class KYO_DSS_F008 extends CrawlingKYOAnnounce {
//
//    public static void main(String[] args) { executeCommand(new KYO_DSS_F008(), args); }
//
//    @Override
//    protected boolean scrap(CrawlingProduct info) throws Exception {
//
...
//        setNapTerm(driver.findElement(By.xpath("//*[@id='5189700_paPd']")), info.getNapTerm(), info.getInsTerm(), 2, false);
//
//        logger.info("▉▉▉▉ 특약 ▉▉▉▉");
