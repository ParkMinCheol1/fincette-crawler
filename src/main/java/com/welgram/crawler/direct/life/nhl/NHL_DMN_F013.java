...
/**
 * 간편한생활비든든NH치매보험(무배당)_2301 2종(표준) 1형(36회보증)
 *
 */

public class NHL_DMN_F013 extends CrawlingNHLAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHL_DMN_F013(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHL_DMN_F013 :: {}", info.getProductName());
        WaitUtil.waitFor(2);
