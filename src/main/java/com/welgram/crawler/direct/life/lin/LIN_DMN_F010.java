...
public class LIN_DMN_F010 extends CrawlingLINAnnounce { // 무배당전에없던실속치매보험(기본형)

    public static void main(String[] args) {
        executeCommand(new LIN_DMN_F010(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_DMN_F010 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
