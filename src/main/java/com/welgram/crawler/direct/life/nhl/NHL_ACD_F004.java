...
// 행복플러스NH재해보험(무배당)_2104 2종(만기환급형)
public class NHL_ACD_F004 extends CrawlingNHLAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHL_ACD_F004(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHL_ACD_F004 :: {}", info.getProductName());
        WaitUtil.waitFor(2);
