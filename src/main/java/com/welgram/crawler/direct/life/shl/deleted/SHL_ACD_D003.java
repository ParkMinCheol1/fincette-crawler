...
// 2022.12.14 			| 최우진 			| 다이렉트 상해
// SHL_ACD_D003			| 신한 365뼈펙트 상해보험M [무배당]
public class SHL_ACD_D003 extends CrawlingSHL {

	public static void main(String[] args) {
		executeCommand(new SHL_ACD_D003(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("생년월일 설정");
		setMobileBirth(info.getFullBirth());
