...
// 2023.07.19 | 최우진 | 신한3COLOR암플러스보장보험(무배당, 해약환급금 일부지급형)
public class SHL_CCR_F011 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_CCR_F011(), args); }
