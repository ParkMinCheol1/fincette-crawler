...
// 2023.07.25 | 최우진 | 신한케어받는간편가입치매간병보험
public class SHL_DMN_F011 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_DMN_F011(), args); }
