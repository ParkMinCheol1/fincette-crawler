...
// SHL_WLF_F026         | 원더풀라이프종신보험(무배당, 해약환급금 일부지급형)
public class SHL_WLF_F026 extends CrawlingSHL {



    public static void main(String[] args) {
        executeCommand(new SHL_WLF_F026(), args);
    }

    @Override
    protected boolean scrap(CrawlingProduct info) throws Exception {
        logger.info("START :: SHL_WLF_F026 :: 원더풀라이프종신보험(무배당, 해약환급금 일부지급형)");
