...
// SHL_WLF_F006         | 신한금리에강한종신보험(무배당, 보증비용부과형)[해약환급금 일부지급형] 체증형_1종(보증형)
public class SHL_WLF_F006 extends CrawlingSHL {



    public static void main(String[] args) {
        executeCommand(new SHL_WLF_F006(), args);
    }

    @Override
    protected boolean scrap(CrawlingProduct info) throws Exception {
        logger.info("START :: SHL_WLF_F006 :: 신한금리에강한종신보험(무배당, 보증비용부과형)[해약환급금 일부지급형] 체증형_1종(보증형)");
