...
// 2023.07.27 | 최우진 | 신한The프리미엄정기보험Ⅱ(무배당)(일반심사형) 15%체증형
public class SHL_TRM_F012 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_TRM_F012(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("▉▉▉▉ 보험형태, 보험기간, 직종구분, 보험종류, 납입기간, 납입주기, 가입금액 ▉▉▉▉");
