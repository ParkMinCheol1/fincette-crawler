...
// 2023.08.03 | 최우진 | 신한CEO정기보험II(무배당, 보증비용부과형) 2종(일반심사형)(10%)체증형
public class SHL_TRM_F021 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_TRM_F021(), args); }

    @Override
    protected boolean scrap(CrawlingProduct info) throws Exception {

        // INFORMATION
        String prodKind = "(10%)체증형";
