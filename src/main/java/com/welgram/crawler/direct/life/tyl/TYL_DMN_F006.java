...
// 2023.11.06 | 최우진 | (무)수호천사NEW내가만드는간병보험(해약환급금 미지급형)
public class TYL_DMN_F006 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_DMN_F006(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_P20121AA2']/div/p/span[1]/b";
        ...
        crawlReturnMoneyList(
            driver.findElements(By.xpath("/html/body/div/div/div/div[23]/table/tbody/tr")),
            info,
            refundOption
        );
