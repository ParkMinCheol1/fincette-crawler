...
public class PLI_TRM_F002 extends CrawlingPLI {

    public static void main(String[] args) { executeCommand(new PLI_TRM_F002(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("상품명 선택");
        selectByVisibleTxt("[@id='selProductist']", "무배당 정기보험");
