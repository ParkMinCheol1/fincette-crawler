...
public class BPL_TRM_F001 extends SeleniumCrawler {

    public static void main(String[] args) {
        executeCommand(new BPL_TRM_F001(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        driver.findElement(By.id("P_S_CEO_TERM_LIFE_jumin_no1")).sendKeys(info.fullBirth);
...

        {
            ...
            WebElement genderElement = driver.findElement(By.cssSelector("label[for='P_S_CEO_TERM_LIFE_" + _gender + "']"));
            genderElement.click();

//            genderElement.sendKeys(Keys.TAB);
        }

        loading();

        {
            WebElement element = driver.findElement(By.cssSelector("#layer_calc01_P_S_CEO_TERM_LIFE"));
...

        {
            ...
            WebElement element = driver.findElement(By.cssSelector("#P_S_CEO_TERM_LIFE_spclCtlCd"));
            element.findElement(By.xpath(".//label[contains(., '" + info.textType + "')]")).click();
//            wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//label[contains(., '" + info.textType + "')]"))).click();
//            driver.findElement(By.xpath("//label[text()='" + info.textType + "']")).click();
        }

        loading();

//        driver.findElement(By.cssSelector("#layer_calc01_P_S_CEO_TERM_LIFE .inner:nth-child(1) li:nth-child(2) > label:nth-child(2)")).click();

        {
            logger.info("가입금액 설정:{}", info.assureMoney.toString());
            driver.findElement(By.cssSelector("#P_S_CEO_TERM_LIFE_spcContAmt")).sendKeys(Integer.parseInt(info.assureMoney) / 100_000_000 + "");
        }
...

        {
            ...
            WebElement dropdown = driver.findElement(By.id("P_S_CEO_TERM_LIFE_spcPayPeriod"));
