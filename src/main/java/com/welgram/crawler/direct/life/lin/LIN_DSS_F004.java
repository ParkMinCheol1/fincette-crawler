...
public class LIN_DSS_F004 extends CrawlingLINAnnounce {

    public static void main(String[] args) {
        executeCommand(new LIN_DSS_F004(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_DSS_F004 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
        ...
        logger.info("직업 선택 :: 경영지원 사무직 관리자");
        setJob();
        driver.switchTo().window(currentHandle); // 창 전환
