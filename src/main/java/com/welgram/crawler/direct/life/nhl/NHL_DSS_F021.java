...
/**
 * 상품명 : 9988NH건강보험(무배당)_2301 1형(간편가입형)건강관리형
 * 상품유형 : 1형(간편가입형)건강관리형
 * 웹 크롤링으로 진행
 *
 */
public class NHL_DSS_F021 extends CrawlingNHLAnnounce {



	public static void main(String[] args) {

		executeCommand(new NHL_DSS_F021(), args);
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("NHL_DSS_F021 :: {}", info.getProductName());
		WaitUtil.waitFor(2);
