...
// todo | By 값 임의 입력 상태 :: 상품 정지라 임의로 작성 @test불가능
// 2023.11.06 | 최우진 | 교보암보험 23.09 (무배당)
public class KYO_CCR_F013 extends CrawlingKYOAnnounce {



    public static void main(String[] args) { executeCommand(new KYO_CCR_F013(), args); }
