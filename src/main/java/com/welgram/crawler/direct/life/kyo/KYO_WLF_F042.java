...
// 2023.09.07 | 최우진 | 교보종신보험 23.08 (무배당) 표준체
public class KYO_WLF_F042 extends CrawlingKYOAnnounce {

    public static void main(String[] args) { executeCommand(new KYO_WLF_F042(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        setInsTerm(driver.findElement(By.xpath("//*[@id='5198700_isPd']")), info.getInsTerm(), 2);
        setNapCycle(driver.findElement(By.xpath("//*[@id='pdtMcrnCd_paCyc']")), info.getNapCycleName(), 2);
        setNapTerm(driver.findElement(By.xpath("//*[@id='5198700_paPd']")), info.getNapTerm(), info.getInsTerm(), 2, false);
