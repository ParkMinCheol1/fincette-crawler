...
public class BPL_ACD_D001 extends CrawlingBPL implements Scrapable {

    public static void main(String[] args) {
        executeCommand(new BPL_ACD_D001(), args);
    }
...
//		option.setImageLoad(true);
    ...
    private boolean crawlFromAnnounce(CrawlingProduct info) throws Exception {
        ...
        logger.info("납입주기 비교");
        this.compareNapCycleNew(info.getNapCycleName());
    ...
    private void compareAssureMoneyNew(Object obj) throws Exception {
        ...
        String targetAssureMoney = targetAssureMoneyText.replaceAll("[^0-9]", "");
        String unitText = targetAssureMoneyText.replaceAll("[0-9]", "");
    ...
    private void compareNapCycleNew(Object obj) throws Exception {
        String title = "납입주기";
        String welgramNapCycle = (String) obj;

        WebElement select = driver.findElement(By.xpath("//*[@id=\"layer_calc01_P_HEALTH_E_MOST\"]/div/div[1]/div/div[2]/div/div[2]/div/div[4]/div/select"));
