...
// SHL_TRM_F001 		| 신한CEO정기보험(무배당, 보증비용부과형) 평준형 일반심사형
public class SHL_TRM_F001 extends CrawlingSHL {

	public static void main(String[] args) {
		executeCommand(new SHL_TRM_F001(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("START :: 신한CEO정기보험(무배당, 보증비용부과형)");
		WaitUtil.waitFor(2);
...
//			driver.findElement(By.xpath("//*[@id='popu_100000000000500']/div[2]/div/div/div[3]/button")).click();
		...
		try {
			...
			throw new CommonCrawlerException("검색중 에러발생");
		}
...
//		helper.doClick(By.xpath("//input[@id='" + genderOpt + "']//parent::li"));
		...
		try {
			...
			throw new CommonCrawlerException(ExceptionEnum.ERROR_BY_MAIN_TERATY);
		}
