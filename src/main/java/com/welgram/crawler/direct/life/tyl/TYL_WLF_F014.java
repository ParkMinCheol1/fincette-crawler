...
// TYL_WLF_F014         | 무배당수호천사유니버셜더확실한종신보험(기본형,표준체)
public class TYL_WLF_F014 extends CrawlingTYL {

    public static void main(String[] args) { executeCommand(new TYL_WLF_F014(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("START :: TYL_WLF_F014 :: 무배당수호천사유니버셜더확실한종신보험(기본형,표준체)");
        ...
        logger.info("주상품 설정");
        setPlanType("(무)유니버셜더확실한종신(보장형)-일반심사형-기본형-표준체");
