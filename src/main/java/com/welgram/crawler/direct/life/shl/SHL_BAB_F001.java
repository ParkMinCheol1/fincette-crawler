...
// 2023.08.23 | 최우진 | 신한주니어큐브종합건강상해보험(무배당, 태아형) (출생후보장)해약환급금미지급형
public class SHL_BAB_F001 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_BAB_F001(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        int unitAmt = 10_000;
        String prodKind = "태아형";
        String planForm = "(출생후보장)해약환급금미지급형";
        ...
        setInsTerm(driver.findElement(By.xpath("//*[@id='mnprDivision']/ul[2]/li[1]/div[2]/select")), /*info.getInsTerm()*/"1년");
        setNapTerm(driver.findElement(By.xpath("//*[@id='mnprDivision']/ul[2]/li[2]/div[2]/select")), /*info.getNapTerm()*/"1년");
