...
/**
 * 간편한생활비든든NH치매보험(무배당)_2204
 *
 */

public class NHL_DMN_F008 extends CrawlingNHLAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHL_DMN_F008(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHL_DMN_F008 :: {}", info.getProductName());
        WaitUtil.waitFor(2);
