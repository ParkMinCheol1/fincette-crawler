...
// 2023.08.23 | 최우진 | 신한주니어큐브종합건강상해보험(무배당) 일반형
public class SHL_CHL_F001 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_CHL_F001(), args); }
