...
public class LIN_CCR_F016 extends CrawlingLINAnnounce { // 무배당암걱정없는표적치료암보험(갱신형)_프리미엄형

    public static void main(String[] args) {
        executeCommand(new LIN_CCR_F016(), args);
    }
    ...
    private void disClosureRoomCrawling(CrawlingProduct info) throws Exception {
        ...
        logger.info("LIN_CCR_F016 :: {}", info.getProductName());
        WaitUtil.waitFor(1);
