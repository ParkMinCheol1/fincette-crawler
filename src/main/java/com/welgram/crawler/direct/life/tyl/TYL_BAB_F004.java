...
// 2023.08.23 | 최우진 | (무)꿈나무우리아이보험(표준형-종합설계형)_태아보장기간
public class TYL_BAB_F004 extends CrawlingTYLAnnounce {

    public static void main(String[] args) {
        executeCommand(new TYL_BAB_F004(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String floatingTreatyName = "(무)꿈나무우리아이보험(표준형-종합설계형)_태아적립";
