...
// AIL_WLF_F006         | 무배당 AIA 안심+ 프라임 종신보험 (해약환급금 50%지급형) 2형(일반심사형)
public class AIL_WLF_F006 extends CrawlingAILAnnounce {

    public static void main(String[] args) { executeCommand(new AIL_WLF_F006(), args); }
