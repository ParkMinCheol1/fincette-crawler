...
// 2023.11.13 | 최우진 | 교보e일잘러케어보험(무배당)
public class KYO_ACD_D002 extends CrawlingKYOAnnounce2 {

    public static void main(String[] args) { executeCommand(new KYO_ACD_D002(), args); }
