...
/**
 * 간편한생활비든든NH치매보험(무배당)_2301 1종(해약환급일부지급) 1형(36회보증)
 *
 */

public class NHL_DMN_F011 extends CrawlingNHLAnnounce {



    public static void main(String[] args) {
        executeCommand(new NHL_DMN_F011(), args);
    }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        logger.info("NHL_DMN_F011 :: {}", info.getProductName());
        WaitUtil.waitFor(2);
