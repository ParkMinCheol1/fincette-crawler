...
// (무) 백년친구 뉴-알차고 행복한 Plus 종신보험(해약환급금 일부지급형)(2401) (1종:기본형,1형:일반심사형)
public class DBL_WLF_F046 extends CrawlingDBLAnnounce {

    public static void main(String[] args) {
        executeCommand(new DBL_WLF_F046(), args);
    }
    ...
    public void crawlReturnMoneyList(Object... obj) throws ReturnMoneyListCrawlerException {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                //현재공시
                String returnMoney = elements.get(i).findElements(By.tagName("td")).get(3)
                    .getAttribute("innerText");        // 현재해약환급금
                String returnRate = elements.get(i).findElements(By.tagName("td")).get(4)
