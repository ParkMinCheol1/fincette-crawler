...
// 2023.07.07 | 최우진 | 신한진심을품은보장보험(무배당, 해약환급금 미지급형)
public class SHL_DSS_F013 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_DSS_F013(), args); }
