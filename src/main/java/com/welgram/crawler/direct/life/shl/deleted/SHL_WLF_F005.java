...
// 2022.07.19           | 최우진               | 대면 종신
// SHL_WLF_F005         | 신한금리에강한종신보험(무배당, 보증비용부과형)[해약환급금 일부지급형] 평준형_1종(보증형)
public class SHL_WLF_F005 extends CrawlingSHL {



    public static void main(String[] args) {
        executeCommand(new SHL_WLF_F005(), args);
    }

    @Override
    protected boolean scrap(CrawlingProduct info) throws Exception {
        logger.info("START :: SHL_WLF_F005 :: 신한금리에강한종신보험(무배당, 보증비용부과형)[해약환급금 일부지급형] 평준형_1종(보증형)");
        ...
        for(int i = 0; i < arrTType.length; i++) {
            ...
            // 0 : 신한금리에강한종신보험(무배당, 보증비용부과형)[해약환급금 일부지급형] 평준형_1종(보증형)
            // 1 : 평준형
            // 2 : 1종 보증형
        }
...
//            selctInsKind.selectByVisibleText("일반");
        ...
        try {
            ...
            logger.info("===================================");
            logger.info("더이상 참조할 테이블이 존재하지 않습니다.");
