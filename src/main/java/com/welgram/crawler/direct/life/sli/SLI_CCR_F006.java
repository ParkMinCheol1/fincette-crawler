...
public class SLI_CCR_F006 extends CrawlingSLIAnnounce {

	public static void main(String[] args) {
		executeCommand(new SLI_CCR_F006(), args);
	}
	...
	protected boolean scrap(CrawlingProduct info) throws Exception {
		...
		logger.info("보험종류");
		String productKind = info.getInsTerm() + " " + info.getProductType();
		By location = By.id("hptsLineCd");
		setPlan(info, location, productKind);

		logger.info("납입 주기 선택");
		location = By.id("padCylCd");
