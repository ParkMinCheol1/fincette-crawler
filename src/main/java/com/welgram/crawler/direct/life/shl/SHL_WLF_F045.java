...
// 2023.07.19 | 최우진 | 신한용감한종신보험(무배당) 해약환급금일부지급형
public class SHL_WLF_F045 extends CrawlingSHLAnnounce {

    public static void main(String[] args) { executeCommand(new SHL_WLF_F045(), args); }
