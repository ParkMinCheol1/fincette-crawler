...
// 2023.04.24 | 최우진 | 무배당수호천사알찬치료비보장보험
public class TYL_DSS_F005 extends CrawlingTYLAnnounce {

    public static void main(String[] args) { executeCommand(new TYL_DSS_F005(), args); }
    ...
    protected boolean scrap(CrawlingProduct info) throws Exception {
        ...
        String unitStandLocation = "//*[@id='div_money_psby1_E27721AC0']/div/p/span[1]/b";
        ...
        submitMainProduct(driver.findElement(By.id("policycd_l")), info.textType);
        pushButton("특약 조회", 3);
