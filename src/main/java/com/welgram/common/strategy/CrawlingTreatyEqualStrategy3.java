 ...
 *
 */
public class CrawlingTreatyEqualStrategy3 implements CrawlingTreatyEqualStrategy {
    ...
    public CrawlingTreatyEqualStrategy3() {
    }

    public CrawlingTreatyEqualStrategy3(TreatyNameComparator treatyNameComparator) {
    ...
    public boolean isEqual(CrawlingTreaty ct1, CrawlingTreaty ct2) {
        ...
        //특약명, 보험기간, 납입기간이 같으면 같은 특약으로 간주합니다.
