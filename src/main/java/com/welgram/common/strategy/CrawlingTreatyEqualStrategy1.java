 ...
 *
 */
public class CrawlingTreatyEqualStrategy1 implements CrawlingTreatyEqualStrategy {
    ...
    public CrawlingTreatyEqualStrategy1() {
    }

    public CrawlingTreatyEqualStrategy1(TreatyNameComparator treatyNameComparator) {
        this.treatyNameComparator = treatyNameComparator;
    }

    @Override
    public boolean isEqual(CrawlingTreaty ct1, CrawlingTreaty ct2) {
        //특약명, 가입금액이 같으면 같은 특약으로 간주합니다.
